...
The [service SEO priorities plan](superpowers/plans/2026-09-05-service-seo-priorities.md) is prepared for execution. Its fresh nine-page receipt identifies six indexed pages, the two prescription URLs awaiting indexing after operator-reported requests, and an unindexed UTI assessment page. Crawl repair is separately pending in PR #517 at that receipt. Preserve the existing certificate/prescription measurement windows and ED/Hair experience cohorts; prepare briefs while their material page changes remain held. External prospects must be freshly qualified: HRM's published contributor guidelines prohibit links to a contributor's own website, so the older HRM-first backlink assumption is not a dependable execution target. This checkpoint records planning and evidence, not completed indexing, outreach, page changes, or production release.
