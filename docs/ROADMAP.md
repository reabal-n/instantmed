...
| 4 | **Prove and scale paid contribution by service** - review performance daily, cut losing queries/assets, repair weak campaigns, and move capital toward services with verified first-order contribution. | **Fresh closed-window and live-account truth 2026-08-24.** Scripts remains enabled at A$60/day with Maximise Conversion Value and tROAS 1.5; its rolling 30 days contain 83 Scripts orders, A$1,249.00 fee-aware contribution, 46.52% margin, and 6.98% refunds. The post-change evidence gate is satisfied and exact proposal `ADS-20260824-03` is validated for A$79/day, below the current fee-aware ceiling; no live budget change has occurred without exact approval. Hair Loss remains enabled at A$10/day: 30 clicks and A$163.29 spend have produced zero recognised orders. Exact proposal `ADS-20260824-02` is validated to pause only the dominant losing phrase keyword while leaving the campaign, exact intent, budget, bids, and ad unchanged. Women's Health remains enabled at A$20/day with 15 clicks, one Ads-attributed order, and 7.99% fee-aware contribution margin. Fresh account read found its canonical hard-exclusion list unattached and that list missing 20 code-owned exclusions; exact atomic repair `ADS-20260824-01` is validated but not applied without exact approval. Medical certificates and ED remain unchanged pending their own evidence gates. | Trusted measurement, positive first-order contribution, healthy service-specific fulfilment, and operator approval for each exact immutable mutation. Scale winners at the maximum economics-authorised step; cut or repair losers. |
...
- **Women's health paid pilot — live 2026-08-18:** campaign `24144825264` (`IM | Search | Women's Health | AU`) is enabled at A$20/day with a A$3 maximum CPC, separate UTI and contraception ad groups, exact/phrase intent only, and no medicine-name targeting. Proposal `ADS-20260818-18` was applied and verified from fresh Google account content before spend. At the 2026-08-24 checkpoint it had 15 clicks and one Ads-attributed order; keep learning while the exact shared-exclusion repair above awaits approval. Prepare a pause proposal only at 30 clicks without another recognised order or A$150 fee-aware contribution loss. Graduate only after at least 20 recognised orders, at least 20% contribution margin, and fewer than 10% refunds.
