...
Two hours remains the clinical-queue operating target; a trailing-seven-day manual-review P95 above two but below six hours is watch, not an automatic cancellation of already-approved bounded acquisition. New campaigns, bid/budget increases, and next product variables require P95 below six hours, zero 24-hour breaches, trusted economics, and support plus completed-QA evidence no older than seven days. Hard evidence of harm still wins: P95 at or above six hours, oldest unreviewed at 20 hours, a 24-hour breach, clinical incident, fulfilment failure, explicit service hold, support above 5 per 100 paid orders, or completed QA behind produces an approval-ready pause proposal. Missing manual or service-control evidence is unavailable and blocks only the next variable; it is not silently treated as healthy and does not pause live spend. No state changes Ads autonomously.
