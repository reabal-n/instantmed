...
| 4 | **Prove and scale paid contribution by service** - review performance daily, cut losing queries/assets, repair weak campaigns, and move capital toward services with verified first-order contribution. | **Fresh closed-window and applied account truth 2026-08-18.** Scripts is enabled at A$60/day with Maximise Conversion Value and tROAS 1.5; its rolling 30 days contain 77 Scripts orders, A$1,194.57 fee-aware contribution, 51.14% margin, and 6.49% refunds. The last material Ads change was 2026-08-18 Sydney time, so the next maximum economics-authorised increase applies immediately after the machine-enforced three closed days plus ten attributed post-change orders. Medical certificates remain at A$20/day and near break-even (24 orders, A$23.29 contribution, 3.41% margin); seven stale agency ads and one losing query were removed before any budget increase. ED remains at A$12/day but now uses Manual CPC with a A$3 base-bid ceiling; its rolling evidence is only marginally positive (5 orders, A$7.17 contribution, 2.87% margin). Hair Loss was relaunched at A$10/day on Manual CPC with a A$3 base-bid ceiling, a verified medicine-free paid destination, controlled RSA, and exact converting-intent keyword after a A$117.10 rolling loss under the prior Smart Bidding setup. Women's Health is live as campaign `24144825264` at A$20/day with a A$3 maximum CPC, separate UTI and contraception ad groups, exact/phrase intent only, and no medicine-name targeting; proposal `ADS-20260818-18` applied and fresh-read verified the complete campaign before spend began. Persisted daily tracking was GREEN at launch approval. | Trusted measurement, positive first-order contribution, healthy service-specific fulfilment, and operator approval for each exact immutable mutation. Scale winners at the maximum economics-authorised step; cut or repair losers. |
...
- **Women's health paid pilot — live 2026-08-18:** campaign `24144825264` (`IM | Search | Women's Health | AU`) is enabled at A$20/day with a A$3 maximum CPC, separate UTI and contraception ad groups, exact/phrase intent only, and no medicine-name targeting. Proposal `ADS-20260818-18` was applied and verified from fresh Google account content before spend. Investigate after 10 clicks without an order; prepare a pause proposal at 30 clicks without an order or A$150 fee-aware contribution loss. Graduate only after at least 20 recognised orders, at least 20% contribution margin, and fewer than 10% refunds.
