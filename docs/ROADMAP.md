...
**2026-09-05 execution order:** close the prescribing completion/recovery, draft-note persistence and truthful notification defects first (PR #520); then recover medical-certificate acquisition/conversion using the refreshed [revenue diagnosis](audits/2026-09-04-scaling-audit.md#2026-09-05-revenue-leak-investigation). The completed seven-day window retained $1,901.65 versus $2,625.35; certificate orders fell 35 to 21 while scripts fell only 37 to 36. Keep the current Scripts $95/day step under its existing three-closed-day/ten-attributed-order gate. Complete Search Console Live Tests and indexing requests for the discovered-but-unindexed prescription pages. Measure refill paid reorders, then retain the Sep 9 weight and Sep 11 hair checkpoints. No new Ads variable or deferred outreach is authorised by this diagnosis. This execution order does not certify the open revenue rung or change its gates.
