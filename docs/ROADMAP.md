...
**Plan 2 investigation decision complete — September 8: no certificate build or commercial change selected.** Certificates stayed at 24 completed-week orders and retained revenue rose A$14.95; the refreshed business decline is concentrated in Women's health and ED. The [Plan 2 execution/measurement handoff](superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md#execution-receipt) and [aggregate receipt](superpowers/receipts/2026-09-08-certificate-revenue-recovery.json) own the diagnosis and limits. Bounded browser baseline accepted with two explicit unfixed synthetic edge findings; local checks and independent Astra review passed; documentation release remains pending. Separate Scripts/Hair pause packet **ADS-20260908-02** passed Google validate-only and awaits operator approval; no Ads change is applied or sent. **Plans 3–5 remain unstarted.** Due reads stay in the standing rhythm; no new reminder or scheduler was created.
...
| 4 | **Prove and scale paid contribution by service** - review performance daily, cut losing queries/assets, repair weak campaigns, and move capital toward services with verified first-order contribution. | **September 8:** certificate no-build decision; price, budget, bid and product unchanged. The approved 2026-09-03 Scripts step from A$79/day to A$95/day was applied and read back; the A$95/day / tROAS 1.5 step has four closed days and 16 attributed orders, but P95 9.221h and 11/107 refunds (10.28%) fail current gates. Hair has one recognized campaign order and −A$178.98 current30 contribution, beyond its A$150 loss cap. Prepare exact campaign-status pauses for Scripts/Hair; no automatic apply. Women's health remains A$20/day and has not met its 20-recognized-order / 90% purity graduation gates. H1/E1 remain active and H2/E2 held under the [opening receipt](superpowers/receipts/2026-08-28-specialty-profitability-opening.json); an approved pause must be recorded as an acquisition confounder. Detailed evidence and packet state live in [Plan 2](superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md#checkpoints-and-separate-commercial-packet). | Trusted measurement, positive first-order contribution, healthy service-specific fulfilment, and operator approval for each exact immutable mutation. Scale winners at the maximum economics-authorised step; cut or repair losers. |
...
- **Hair-loss paid pilot — 2026-09-11 readout retained:** one recognized campaign order now exists, but September 8's −A$178.98 current30 contribution already crosses the A$150 loss cap. The crossed loss gate requires us to produce the exact campaign-status pause proposal for operator approval now; ADS-20260908-02 passed validate-only. Read back actual account/approval status on September 11. The Ads Agent must not apply the pause autonomously; no H2 activation or rebuilt campaign is authorized.
