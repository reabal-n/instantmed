...
>
> **Last refreshed:** 2026-09-14. Refresh whenever priority or status changes; perform a deliberate review at least monthly.
...
**Plan 1 engineering releases through PR #536 are complete, including the Telegram correction and its normal production observation.** Its [execution receipt](superpowers/plans/2026-09-06-01-checkout-data-reliability.md#execution-receipt) owns the release ledger. The [September 8 Plan 2 observation refresh](superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md#plan-1-observations-refreshed-here) found a healthy normal review-request outcome: one sent/stored-delivered and three future cooldowns, zero due; independent Resend verification remains unavailable. Dependable two-hour browser cadence was **not accepted**: four actual scheduled completions had 4–6-hour internal gaps and an 8h07m boundary gap. The six-hour observer threshold does not prove two-hour execution. **September 14 monitoring follow-up:** use the existing Vercel cron as the primary trigger, retaining GitHub native scheduling as an independent fallback, for the same browser workflow and retaining provider-returned run IDs. The proposed stale threshold is 150 minutes. Implementation, Actions-token configuration, deployment and observed cadence remain separate gates; no dependable post-release cadence or provider alert receipt is claimed yet. The historical critical incident remains acknowledged without repeat delivery, not clinically resolved.

**Plan 2 complete — September 8.** Certificates stayed at 24 completed-week orders and retained revenue rose A$14.95, supporting the released no-certificate-build decision. The operator approved [ADS-20260908-03](superpowers/receipts/2026-09-08-specialty-acquisition-repair.md); the two selected Hair/ED keywords were disabled and verified, while every campaign, budget, bid, ad and other keyword stayed unchanged. The [Plan 2 handoff](superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md#execution-receipt) owns the release, provider receipts, independent account comparison and browser limits. Hair/ED product cohorts are confounded from the recorded September 8 apply start; measure September 9–15 on September 16, with September 11's interim and September 19's ED settlement observations retained. The operator permits case-by-case Panadeine Forte prescribing and is concerned about repeated requests; no blanket exclusion or automatic repeat rule was selected. Women's child-page intent preselection already exists; any future paid-destination test needs its own reviewed control change and exact approval.

**Plan 3 density correction merged and deployed, September 9 — final visual sign-off pending.** [PR #543](https://github.com/reabal-n/instantmed/pull/543) delivered the operator-approved compact prescribing header, Clinical details disclosure, grouped screening and consolidated status. Independent review, required CI and production smoke passed; the [correction receipt](superpowers/plans/2026-09-06-03-concise-clinical-review.md#operator-density-correction--september-9) records exact source/deployment evidence and the retry-dependent browser cases. Its automatic review of the unchanged public funnel scored 7/10 against the 8/10 target; no quality exception or final acceptance of the staff visuals has been recorded. **Plan 4 merged and deployed September 10 Sydney under the operator's later approval. Local release checks, required CI, production and dashboard-authentication smoke passed. The [Plan 4 receipt](superpowers/plans/2026-09-06-04-parchment-prescribing-workspace.md#final-release-receipt--september-10-sydney) owns final source/deployment evidence, automatic review, retry limitations and outstanding staff/provider/device acceptance. Plan 5 remains unstarted.** Commercial observation continues independently; no new reminder or scheduler was created.

**Operator-approved quality pass — September 10, PR #549 merged and deployed; bounded homepage, confirmation and reload refinements implemented.** The 7/10 review concerned the public homepage-to-Review & pay journey, not a score of Plan 3's clinician workspace. The pass fixes homepage hierarchy, the illustrative review, fixed-header obstruction, long answers, input contrast and draft recovery. Its local recording scored 8/10 combined; the subsequent production recording scored 7/10 and prompted a bounded correction to the competing secondary headline and duplicate Google stars. Actual rendered-font inspection also found homepage headings retained Arial after the configured font loaded; a small homepage-only font subset and a delayed-load browser regression correct that defect. The pre-consent action now says "Review & confirm" before showing Pay after confirmation. A reproduced timestamp boundary no longer discards a saved review when the clock moves back slightly. The [quality receipt](superpowers/receipts/2026-09-10-patient-journey-quality.md) owns the separate public/staff browser evidence, original review scores, governed release records and remaining hosted-payment/provider/device/operator acceptance. No 10/10 or operator acceptance is claimed. Plan 5 remains unstarted; no conversion uplift is established.

The [September 12 accessibility follow-up](superpowers/receipts/2026-09-10-patient-journey-quality.md#accessibility-follow-up--september-12) corrects the prescription illustration's contrast and ED caption semantics, with separate browser and release evidence. The [September 13 reliability follow-up](superpowers/receipts/2026-09-10-patient-journey-quality.md#reliability-follow-up--september-13) addresses server-rendered ED FAQs and three retry-dependent browser scenarios; its ledger separates release evidence from the unresolved attribution of one earlier hydration error. Parchment API/SSO readiness passed. Dedicated Stripe sandbox credentials are now configured and both real hosted checkout branches passed locally; the [hosted-payment follow-up](superpowers/receipts/2026-09-10-patient-journey-quality.md#hosted-payment-follow-up--september-13) owns the CI billing-country correction and evidence. Live prescription confirmation and operator acceptance remain separate gates. The operator deferred the physical-phone check. Plan 5 remains unstarted.
...
| 4 | **Prove and scale paid contribution by service** - review performance daily, cut losing queries/assets, repair weak campaigns, and move capital toward verified first-order contribution. | **September 9 owner decision, applied September 9–10:** fixed refund, queue, sample, purity and waiting vetoes are superseded by the cash-profit rule below. Scripts losing keywords are paused and tROAS is 1.35 at $95/day. Certificates run 24/7 at $20/day and $22 tCPA; four incorrect exclusions are removed and bounded work-certificate copy replaces the old no-call ad. Women’s matching UTI/pill destination ads are created and under Google review, with old ads retained until replacements can serve. ED excludes unsupported TRT; Hair remains at $10/day for its September 16 repair readout. All applied changes have exact approval and read-back receipts. [Execution and observation ledger](audits/2026-09-10-profit-growth-execution.md) owns current state; older Plan 2 receipts remain historical. | Verified positive first-order contribution, trusted cash/attribution and exact operator-approved changes. Actual clinical incidents, service holds, failed fulfilment and concrete compliance failures remain blocking; elapsed review time is advisory. |
...
### Growth operating policy — revised 2026-09-09

**Commercial policy — owner decision 2026-09-09:** verified positive first-order cash contribution qualifies profitable-scale proposals, with actual refunds, disputes, payment fees and all campaign Ads spend deducted. Numeric refund, queue/wait, support/QA workload, margin, order-count, service-purity and fixed post-change waiting gates are superseded. These remain advisory investigation and uncertainty signals. Actual clinical incidents, explicit service holds, fulfilment failures and untrusted financial/attribution evidence remain blocking. Every Ads change still requires the exact immutable operator-approved packet and spend bounds. The cash/first-order definitions and current enforcement live in `docs/REVENUE_MODEL.md` and `docs/OPERATIONS.md`.
...
An open **Attribution Investigation Hold** blocks scaling for that service even when tracking returns to GREEN. It clears only after the cause is recorded, any required correction is complete, a fresh reconciliation establishes trustworthy attribution, and the Operator records an explicit **Attribution Investigation Resolution**. An unknown cause cannot be cleared. The September 9 decision removes numeric purity/order and fixed waiting graduation; actual attribution faults still require resolution.
...
- **AI referrals and certificate comparison — PR #546:** the [source and measurement changes](https://github.com/reabal-n/instantmed/pull/546) preserve the first landing through SDK loading and refresh the existing comparison's prices, citations and service link. Use the PR's actual deployment timestamp as the observation cutoff. More captured passive visits are a measurement change; judge acquisition using paid orders and cash contribution, and establish a fresh session baseline before comparing conversion percentages.
...
- **Hair-loss paid pilot — 2026-09-11 readout retained:** one recognized campaign order now exists, but September 8's −A$178.98 current30 contribution crosses the A$150 loss cap. The rule required us to produce the exact campaign-status pause proposal for operator approval; ADS-20260908-02 passed validate-only and was then **rejected**. The operator selected acquisition repair with the campaign kept live at A$10/day. ADS-20260908-03 is applied and verified; inspect its early paid contribution on September 11 and the seven-closed-day result on September 16; retain the loss-cap breach as evidence, without treating continued observation as graduation. The Ads Agent must not apply the pause autonomously; no H2 activation or rebuilt campaign is authorized.
- **Women's health paid pilot — September 9–10 repair:** campaign `24144825264` remains enabled at A$20/day with a A$3 maximum CPC. The August 10–September 8 window has 13 recognised orders (11 women’s orders and two Scripts orders), with $271.43 verified first-order contribution. Matching UTI/pill destination RSAs are created under ADS-20260909-01; Google review remains pending, so old hub ads are retained until the replacements can serve. Known repeat-pill handoffs must be distinguished from unrelated leakage, but historical purchase rows lack that durable marker; report the limitation instead of inventing the split. Fixed order/purity graduation is superseded by the September 9 cash-profit decision.
...
- **Hair/ED keyword-repair observation — 2026-09-16:** compare September 9–15 after ADS-20260908-03, separating the partial apply-day. Hair remains unchanged at $10/day; the September 10 ED TRT exclusion creates another exposure boundary. Use verified contribution and qualified orders, keep the September 19 ED settlement check, and disclose the confounded ED window. No automatic campaign pause.
...
- **Existing copy windows — 2026-09-24 and 2026-10-24 Sydney:** preserve the August 25 certificate and prescription release boundaries in [Plan 2](superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md#existing-release-and-measurement-boundaries). September 9 authorises a bounded refresh of the stale certificate comparison page and a clearer service link; record its production timestamp as a new exposure boundary. The overlapping Ads, copy and measurement changes limit causal attribution rather than imposing another waiting veto.
