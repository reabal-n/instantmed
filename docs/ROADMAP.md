...
**Plan 1 follow-up source and reviews are complete; monitoring is released and checkout release is pending. Plan 2 is held.** The historical profile repair remains complete: 773 missing copies were filled across 466 profiles, all 1,107 eligible copies authenticated, none remained missing and the approved zero-change rerun wrote nothing. No production-data approval blocker or repair rerun remains. The initial checkout/monitoring releases, two-hour browser request, expected-cooldown classification and CI retrieval correction retain their historical proof in the [execution receipt](superpowers/plans/2026-09-06-01-checkout-data-reliability.md#execution-receipt). Confirmed follow-up work now covers the expired-request dead end, owner/service-aware payment recovery and diagnostics, observer partial-read/cache compare-and-set preservation, exact workflow/metric contracts, honest manual-versus-scheduled cadence and sequential failure/recovery proof. Monitoring PR #532 passed exact-head CI and production deployment/smoke. Checkout has independent source acceptance, 49 isolated database cases and bounded browser proof; its integrated CI and production release remain pending. Actual scheduled-browser silence is still detected by the independent watcher, so cadence acceptance remains open. Do not mark the follow-up complete until the remaining release checks and applicable runtime acceptance are recorded. Plans 2–5 remain unstarted. Execution receipts own task proof; Git/PR/deployment history owns releases. Due measurement reads remain part of the standing operating rhythm and are checked at each session start, so the build sequence does not postpone the Sep 9/11/19 checkpoints. Commercial observation may continue while this bounded internal reliability work proceeds.
...
| 4 | **Prove and scale paid contribution by service** - review performance daily, cut losing queries/assets, repair weak campaigns, and move capital toward services with verified first-order contribution. | **Specialty opening receipt captured 2026-08-28.** Hair H1 and ED E1 are live from production SHA `ad2c450c1fa28b19c953e384d647fec11b42c58f`; the registry now uses the exact Vercel-ready boundary `2026-08-28T05:13:53.870Z`, not Sydney midnight. The closed pre-window ending 2026-08-27 recorded Hair at 44 clicks, A$132.32 spend, zero retained orders, and -A$132.32 contribution; ED recorded 97 clicks, eight retained orders, A$51.02 contribution, and 12.46% margin. Hair and ED remain enabled at A$10/day and A$12/day respectively with Manual CPC. The canonical delivered Ads run for 2026-08-27 was `GREEN`; the direct snapshot's `TRACKING_HEALTH_NOT_CLASSIFIED` value is its intentional fail-closed placeholder, not the classified verdict. H2/E2 remain inactive, no Hair/ED Ads variable changes during the H1/E1 product window, and neither service may graduate commercially before its retained-order and contribution gates. The approved 2026-09-03 Scripts step from A$79/day to A$95/day was applied and read back; Scripts remains at A$95/day with Maximise Conversion Value and tROAS 1.5 while the three-closed-day / 10-retained-order observation gate matures. This status does not authorise another step. Women's Health remains at A$20/day. Medical-certificate price, budget, and product stay unchanged while its organic window matures. Exact PHI-free specialty-opening evidence is pinned in `docs/superpowers/receipts/2026-08-28-specialty-profitability-opening.json`; the later Scripts read-back is recorded in `docs/audits/2026-09-04-scaling-audit.md`. | Trusted measurement, positive first-order contribution, healthy service-specific fulfilment, and operator approval for each exact immutable mutation. Scale winners at the maximum economics-authorised step; cut or repair losers. |
...
The [service SEO priorities plan](superpowers/plans/2026-09-05-service-seo-priorities.md) delivered its bounded on-site batch in merged PR #518; the current production release includes it. The nine-page query/link inventory and five service briefs are complete, and public robots/representative assets passed crawl checks. Both prescription pages passed authenticated Search Console Live Tests on 5 September; `/prescriptions` was submitted and the existing `/online-prescriptions` request was confirmed. Actual indexing and the remaining page-specific GSC tasks require fresh read-back; do not repeat submitted requests daily. The public change clarified only the UTI and new/switch pill child-page assessment summaries/process wording. Existing certificate/prescription measurement windows and ED/Hair cohorts remain intact, with material changes held to their gates. External visibility, including prospect research and drafts, remains deferred. Session 2 owns the next evidence-backed commercial selection.
...
- **Hair-loss paid pilot — 2026-09-11:** read back the exact live campaign state and recheck retained orders, fee-aware contribution, refunds, fulfilment, and queue health. If the pilot still has no retained order, produce the exact campaign-status pause proposal for operator approval. The Ads Agent must not apply the pause autonomously, and this checkpoint does not authorise a different variable or a rebuilt campaign.
- **Women's health paid pilot — live 2026-08-18:** campaign `24144825264` (`IM | Search | Women's Health | AU`) is enabled at A$20/day with a A$3 maximum CPC, separate UTI and contraception ad groups, exact/phrase intent only, and no medicine-name targeting. Proposal `ADS-20260818-18` was applied and verified from fresh Google account content before spend. At the 2026-08-24 checkpoint it had 15 clicks and one Ads-attributed order; proposal `ADS-20260824-01` then repaired and verified the canonical shared-exclusion attachment with zero code-owned exclusions missing. Keep learning. Prepare a pause proposal only at 30 clicks without another recognised order or A$150 fee-aware contribution loss. Graduate only after at least 20 recognised orders, at least 20% contribution margin, and fewer than 10% refunds.
