...
- **Women's health paid pilot — approved 2026-08-18:** launch `IM | Search | Women's Health | AU` at A$20/day with a A$3 maximum CPC, separate UTI and contraception ad groups, exact/phrase intent only, and no medicine-name targeting. Investigate after 10 clicks without an order; prepare a pause proposal at 30 clicks without an order or A$150 fee-aware contribution loss. Graduate only after at least 20 recognised orders, at least 20% contribution margin, and fewer than 10% refunds.
