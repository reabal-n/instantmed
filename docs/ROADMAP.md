...
>
> **Last refreshed:** 2026-09-05 for service SEO priorities; other operating receipts retain their stated checkpoint dates. Refresh whenever priority or status changes; perform a deliberate review at least monthly.
...
| 4 | **Prove and scale paid contribution by service** - review performance daily, cut losing queries/assets, repair weak campaigns, and move capital toward services with verified first-order contribution. | **Specialty opening receipt captured 2026-08-28.** Hair H1 and ED E1 are live from production SHA `ad2c450c1fa28b19c953e384d647fec11b42c58f`; the registry now uses the exact Vercel-ready boundary `2026-08-28T05:13:53.870Z`, not Sydney midnight. The closed pre-window ending 2026-08-27 recorded Hair at 44 clicks, A$132.32 spend, zero retained orders, and -A$132.32 contribution; ED recorded 97 clicks, eight retained orders, A$51.02 contribution, and 12.46% margin. Hair and ED remain enabled at A$10/day and A$12/day respectively with Manual CPC. The canonical delivered Ads run for 2026-08-27 was `GREEN`; the direct snapshot's `TRACKING_HEALTH_NOT_CLASSIFIED` value is its intentional fail-closed placeholder, not the classified verdict. H2/E2 remain inactive, no Hair/ED Ads variable changes during the H1/E1 product window, and neither service may graduate commercially before its retained-order and contribution gates. Scripts remains at A$79/day with Maximise Conversion Value and tROAS 1.5; Women's Health remains at A$20/day. Medical-certificate price, budget, and product stay unchanged while its organic window matures. Exact PHI-free evidence is pinned in `docs/superpowers/receipts/2026-08-28-specialty-profitability-opening.json`. | Trusted measurement, positive first-order contribution, healthy service-specific fulfilment, and operator approval for each exact immutable mutation. Scale winners at the maximum economics-authorised step; cut or repair losers. |
