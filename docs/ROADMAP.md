...
>
> **Last refreshed:** 2026-09-09. Refresh whenever priority or status changes; perform a deliberate review at least monthly.
...
- **Women's health paid pilot — live 2026-08-18:** campaign `24144825264` remains observed enabled at A$20/day with a A$3 maximum CPC and its existing scoped intent. September 8 current30 evidence is **13 recognized orders, 11 expected-service (84.6% purity)**. Those historical numeric graduation gates are superseded by the September 9 first-order cash policy. Keep expected-service women’s orders, known repeat-pill handoffs and unrelated leakage distinct; current purchase data lacks the durable handoff marker, so the split remains unavailable. Historical launch and exclusion-repair receipts remain in the dated audit; no new variable is authorized.
...
- **Hair/ED keyword-repair observation — 2026-09-16:** compare September 9–15 after verified ADS-20260908-03; separate the September 8 partial apply-day. Use retained contribution and qualified orders, preserving original pilot gates and the September 19 ED settlement check. No automatic next change or campaign pause.
