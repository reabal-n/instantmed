...
| **Cron** (29) | `/api/cron/*` | See OPERATIONS.md for full cron table |
...
| `app/api/` | API routes (94 route files) | `stripe/webhook/`, guarded payment reconciliation, `cron/`, `health/`, `certificates/`, `intakes/`, Twilio voice handlers, and the count-only `internal/support-inbox-alert/` diagnostic bridge |
