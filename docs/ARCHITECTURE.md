...
| `supabase/migrations/` | 104 SQL migration files (1 squashed baseline + 103 incremental). Most recent: `20260723063000_suppress_recovery_after_intake_creation.sql` (anti-joins real intakes from partial-draft recovery; release-ordered after the merged-profile auth and draft-discard fence migrations). |
