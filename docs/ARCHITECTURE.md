...
| **Doctor** | `/api/doctor/*` | `assign-request`, `certificates/[intakeId]/download`, `drafts/[intakeId]`, `intakes/[id]/audit-view`, `intakes/[id]/lock`, `intakes/[id]/review-data`, `log-view-duration`, `onboarding-status`, `patients/[patientId]/health-profile`, `patients/[patientId]/summary`, `scripts`, `scripts/[id]` |
