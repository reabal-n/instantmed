...
| Canonical | Aliases (redirect) | Notes |
|---|---|---|
| `/request` | `/flow`, `/flow/:path*`, `/prescriptions/request`, `/prescriptions/repeat`, `/prescriptions/new`, `/consult/request`, `/medical-certificate/request` | Sole intake flow (commit `18e26f0b7` killed the parallel `/flow` system) |
...
| `consult` (hair loss) | hair-loss-goals, hair-loss-assessment, hair-loss-health, hair-loss-preferences, medical-history, details, review, checkout |
