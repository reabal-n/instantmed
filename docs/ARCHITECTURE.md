...
| `supabase/migrations/` | 102 SQL migration files (1 squashed baseline + 101 incremental). Most recent: `20260722223000_exclude_merged_profiles_from_auth_link.sql` (keeps the Auth insert trigger and central auth hydration on open canonical patient profiles; pending production apply). |
