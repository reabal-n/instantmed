...
| `app/api/` | API routes (95 route files) | `stripe/webhook/`, guarded payment reconciliation, `cron/`, `health/`, `certificates/`, `intakes/`, Twilio voice handlers, and the count-only `internal/support-inbox-alert/` diagnostic bridge |
