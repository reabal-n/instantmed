...
| `supabase/migrations/` | 105 SQL migration files (1 squashed baseline + 104 incremental). Most recent: `20260723150000_review_request_click_funnel.sql` (additive, aggregate-only review-request traversal measurement and service-role funnel reads; applied 2026-07-23 with aligned history, clean linked schema lint, valid unique index, service-role-only RPC execution, and a successful live aggregate read). |
