...
| `app/api/` | API routes (93 route files) | `stripe/webhook/`, `cron/`, `health/`, `certificates/`, `intakes/`, Twilio voice handlers, and the count-only `internal/support-inbox-alert/` diagnostic bridge |
