...
| `supabase/migrations/` | 105 SQL migration files (1 squashed baseline + 104 incremental). Most recent: `20260723150000_review_request_click_funnel.sql` (additive, aggregate-only review-request traversal measurement and service-role funnel reads; production application is release-gated). |
