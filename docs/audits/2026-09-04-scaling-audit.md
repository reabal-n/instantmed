...
> **Reconciled 6 September 2026; diagnosis refreshed 8 September below.** Original text remains in Git history. Each dated investigation remains evidence for its stated windows, not a current execution queue.
>
...
## September 8 diagnosis refresh — Plan 2

**No certificate build or commercial change selected.** The fresh completed Sydney comparison is **September 1–7 versus August 25–31**: total retained revenue **A$2,106.35 versus A$2,271.10**, down A$164.75 (7.3%), while total orders rose 68 → 72. Certificates held **24 → 24 orders** and retained **A$653.80 → A$668.75**. Service deltas were Women's health −A$259.70, ED −A$79.80, certificates +A$14.95, prescriptions +A$109.85 and hair +A$49.95. The older 62.8% certificate share above remains correct only for its September 4 window.

Canonical cash completeness passed and an independent aggregate ledger read reconciled 1/7/prior-7/30-day totals without discrepancy. Current30 retained is **A$9,298.85 on 298 orders**; contribution after fees/Ads is **A$5,647.17**, using actual fee receipts plus the canonical fallback where unavailable. This is before fixed overhead. The [September 8 aggregate receipt](../superpowers/receipts/2026-09-08-certificate-revenue-recovery.json) keeps cash-event refunds separate from campaign snapshot accounting; blended retained/spend is not paid ROAS.

The strongest remaining certificate constraint is observed acquisition mix/weak qualified entry, not a demonstrated form or fulfilment collapse. AI-attributed certificate orders fell **11 → 4**, offset by other channels; that does not prove an algorithm change. Equal 24-hour exact-flow cohorts, August 24–30 versus August 31–September 6, returned **45/28/26/25 → 36/22/21/20** start/checkout/handoff/ordered-paid. Mobile start→checkout was **23/37 → 20/33**. These tracked subsets do not share the cash denominator. Current30 GSC main-page position is 52.56 and only 11 clicks were reported; limited visible query/device rows do not reconcile to page totals. September has 28 approved/completed reportable paid certificate requests and zero missing valid records, with no current reportable paid queue at the observation. These record checks are not independent patient-delivery proof.

Paid certificates remain too thin for more spend: current30 **A$67.02 / A$663.70 = 10.1% contribution margin**, current7 **−A$18.52**. Lost impression share and small query samples do not justify a bid, budget or headline change. Keep the September 4 unknown, September 6 persistence, and September 7 recovered certificate session failure separate; the bounded taxonomy read is not an all-error absence claim.

**Separate current checkpoint actions:** Scripts has four closed post-step days and 16 expected attributed orders, but P95 **9.221h** and **11/107 refunds (10.28%)** fail the next-scale gates. Hair now has one recognized campaign order, but **−A$178.98** pre-repair current30 contribution exceeds its A$150 loss cap. The operator rejected Scripts/Hair campaign-pause packet ADS-20260908-02, then explicitly approved the bounded Hair/ED keyword repair **ADS-20260908-03**. The two keyword changes are applied and verified, with all campaigns and budgets unchanged; [the receipt](../superpowers/receipts/2026-09-08-specialty-acquisition-repair.md) records the exact resources and independent account comparison. Women's has **11 expected-service / 13 recognized orders (84.6%)**, below its **20 recognized-order / 90% purity** graduation gates; its positive A$318.32 current30 contribution and intentional repeat-pill handoff remain distinct from Hair. Keep September 9 weight, September 11 interim Hair, September 16's first full repair read, September 19 settled ED, the September 24/October 24 copy closes and September 27 refill-wave maturity. The affected H1/E1 cohorts are confounded from the recorded apply start; no new reminder or scheduler was created.

The normal review-request run completed with one sent/stored-delivered and three future cooldowns, zero due; independent Resend verification remains unverified. Two-hour browser cadence failed its requested observation: four actual scheduled completions with 4–6-hour gaps and an 8h07m boundary gap, despite a clear six-hour observer. The historical critical incident stayed acknowledged without repeat paging; March document disposition and nine retrospective cases remain clinician-owned. The [Plan 2 execution and measurement handoff](../superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md#execution-receipt) owns exact evidence, the rejected pause, verified keyword repair, accepted bounded browser baseline and the **September 15** next revenue read. Browser QA found unfixed long-name clipping and a cookie-storage crash under injected write denial; neither establishes prevalence or revenue causality. Plan 2 is complete: the certificate no-build decision is released and the approved specialty keyword repair is verified; commercial observation remains open. Plans 3–5 are unstarted.
