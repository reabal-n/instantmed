...
| `<DashboardPageHeader>` replaces 16 hand-rolled `text-2xl font-semibold tracking-tight` h1s | Done (v2.0.0) | Visible in `intakes-client.tsx`, `settings-client.tsx`, `messages-client.tsx`, `health-summary/client.tsx`, etc. |
