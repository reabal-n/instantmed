...
The recent A$29.95 refund remains retryable within its existing matching grace, ending September 25 at 03:06:58.863 UTC (13:06 Sydney). The hourly cron remains responsible for retrying it; do not shorten the grace or mark it successful merely to clear `partial_failure`. Local Data Manager status lookup was unavailable, so purchase-upload acceptance is not proof of eventual Google matching.
