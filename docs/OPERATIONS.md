...
**Application release — 2026-09-06:** PR #527 passed exact-head CI `34027297774` on `f225c1d807997f91c28b6bb53f73d17934a57565` and merged as `f7b2e43aa3d126cb05020c0ea7b27e016feeb82d`. The primary production alias matched READY deployment `dpl_Foxpmwb6xNG5NeEQfbKWuSPYvkZw` at 11:12:08.402 UTC; post-deploy smoke `34029556180` passed. First scheduled observer persistence and the subsequent cadence window remain separate pending evidence. The initial read showed both seeded version-1 rows with no checked-at timestamp, so it is not execution proof.
