...
15. **`components/operator/`** — `OperatorShell`, bounded staff pages, split panes, panels, and `StaffCommandPalette`. All admin/operator/support pages use this shell; do not rebuild separate admin/doctor mode shells.
