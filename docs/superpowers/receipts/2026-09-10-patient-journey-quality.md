...
| Required CI and production | Exact PR-head checks, merge/tree identity, READY deployment/alias, and post-deploy smoke must be recorded independently. Local browser and loopback results do not stand in for these receipts. |
