...
| 2026-09-03 | Definitive exact-SHA Task 6 verification | Tested pre-receipt implementation `daeb9d19fe181e463772fc355f3deaa021779d30`; replaces every earlier Task 6 receipt | PASS: the final review of the superseded receipt found four material defects, and this exact candidate closes them: percent-encoded private or capability paths now fail closed through repeated decoding; GSC page and query reads paginate in 25,000-row batches with a 250,000-row complete-read ceiling; successful partial-recovery sends are windowed by `recovery_email_sent_at`; and all 42 city entries plus rendered location, shared-step, and schema copy are constrained to medical-certificate requests, eligible repeat-prescription reviews, named specialty pathways, individual doctor review, and if-approved eScripts. Exact-tree gates passed: 9 focused files / 116 tests; 10 documentation specs / 121 tests / 123 Markdown docs; route-conflict check; lint; typecheck; `git diff --check`; full 702 files / 6,497 tests; and `SENTRY_AUTH_TOKEN= corepack pnpm build`, which compiled successfully and generated 482/482 pages/routes without a Sentry release or source-map upload. The exact built artifact passed seven indexed-city HTTP 200/canonical/H1/scoped-copy checks, 35 valid JSON-LD payloads, the exact seven-owner location sitemap with no Gold Coast owner, all 13 exact HTTP 308 redirects, all three pruned-surface checks, and ISO `lastmod` evidence dated 2026-08-28 for `/`, `/medical-certificate`, `/medical-certificate-online`, `/about`, and `/contact`, and 2026-08-29 for `/telehealth-australia` plus the seven indexed cities. A 32-view eight-route desktop/mobile light/dark browser matrix passed exact canonical, non-empty H1, valid JSON-LD, footer `data-nosnippet`, internal links, actual theme, index/noindex expectation, scoped copy, zero horizontal overflow, fully revealed location content, and zero page, console, failed-request, or HTTP 4xx/5xx errors. Two mobile `/telehealth-australia` pages exceeded Chromium's 16,384px single-surface capture limit; DOM and bottom-viewport probes proved exactly one hero, H1, main, facts block, and complete footer, so the corrupt full captures were replaced by six exact non-overlapping CDP clips covering 0-17,435px with explicit light/dark app theme. Independent visual review passed the complete 36-file active evidence set with no material clipping, overflow, missing content, failed reveal, contrast, theme, or layout defect. The read-only GSC audit for 2026-05-26 to 2026-08-24, generated at 2026-09-03T10:10:32.617Z, found 151 unique live-sitemap URLs, 79 performance pages, 33 pages with clicks, six live sitemap endpoints returning HTTP 200/OK with no weak groups, and 21 branded landing pages; its inspected `/medical-certificate` URL was submitted and indexed, robots allowed, indexing allowed, fetched successfully, mobile-crawled at 2026-08-28T05:07:37Z, with exact matching Google- and user-selected canonicals. The aggregate 30-day audit generated at 2026-09-03T10:10:22.615Z for 2026-08-04T10:10:22.615Z to 2026-09-03T10:10:22.615Z found 305 reportable intakes created, 283 orders paid in-window, $9,313.60 gross, $304.25 refunded, $9,009.35 net retained, and $31.84 net AOV; 302 partial intakes yielded 34 captured emails, 26 correctly windowed partial-recovery sends, 25 abandoned-checkout sends, 7 converted markers, 5 recovered paid orders, and $144.75 recovered net. PostHog returned HTTP 200 with 765 intake starts, 467 checkout views, and 284 server purchase completions. The protected Google Ads source returned HTTP 200 with $3,201.71 spend, 748 clicks, 153 local orders, $5,156.25 local net revenue, $20.93 local CAC, and 1.610 local ROAS. All four aggregate artifacts passed a zero-match privacy scan for paid-rate fields, raw query keys or strings, percent-encoded values, UUIDs, email addresses, click identifiers, certificate identifiers, patient or intake identifiers, and auth-token keys. Generated artifacts, active and superseded screenshots, and probes were moved recoverably to Trash; the temporary environment symlink was removed; port 3060 and all agent-browser sessions were closed; the isolated tree was clean; and the main worktree's pre-existing user changes were unchanged. No push or deployment occurred. Hosted exact-SHA behaviour, a fresh Google recrawl/index change, actual Google snippet/sitelink or SERP movement, and post-deploy revenue impact or causality remain unverified. | Independent base-to-receipt review before any PR or production action |
