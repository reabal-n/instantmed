...
| 2026-09-03 | Definitive exact-SHA Task 6 verification | Tested pre-receipt implementation `e97b17f961ad4652e9f44dcd14b9c0306008f02d`; replaces every earlier Task 6 receipt | PASS: independent review found material audit-population, recovery-window, and overbroad clinical-copy defects in superseded candidates. The implementation now separates `createdIntakes` from `paidAtOrders`, windows successful recovery email sends by `sent_at`, removes the invalid paid-rate inference, and keeps indexed/noindex location and intent copy branch-aware and within the active service scope. Exact-tree gates passed: 9 focused files / 113 tests; 10 documentation specs / 121 tests / 123 Markdown docs; route-conflict check; lint; typecheck; `git diff --check`; full 702 files / 6,494 tests; and an upload-disabled production build compiling successfully and generating 482/482 static pages/routes. The first isolated build attempt stopped at environment validation because the verification worktree lacked `.env.local`; after temporarily linking the existing local verification environment, `SENTRY_AUTH_TOKEN= corepack pnpm build` passed without a Sentry release or source-map upload. The read-only GSC audit for 2026-05-26 to 2026-08-24, generated at 2026-09-03T09:09:20.943Z, found 151 unique live-sitemap URLs, 79 performance pages, 33 pages with clicks, six live sitemap endpoints returning HTTP 200/OK with no weak groups, and 21 branded landing pages; its one inspected `/medical-certificate` URL was submitted and indexed, robots allowed, indexing allowed, fetch successful, mobile-crawled at 2026-08-28T05:07:37Z, with exact matching Google- and user-selected canonicals. The aggregate 30-day audit generated at 2026-09-03T09:09:25.937Z for 2026-08-04T09:09:25.937Z to 2026-09-03T09:09:25.937Z found 305 reportable intakes created and 283 orders paid in-window, $9,313.60 gross, $304.25 refunds, $9,009.35 net retained, and $31.84 net AOV; 25 recovery sends produced 5 paid orders and $144.75 recovered net. PostHog returned HTTP 200 with 765 intake starts, 467 checkout views, and 284 server purchase completions. The protected Google Ads source returned HTTP 200 with $3,188.18 spend, 745 clicks, 153 local orders, $5,156.25 local net revenue, $20.84 local CAC, and 1.617 local ROAS. The exact production artifact passed all seven indexed deep-city DOM/schema and branch-aware-copy checks, the exact seven-owner location sitemap with no Gold Coast owner, all 13 exact HTTP 308 redirects, and all three pruned-surface checks. A 32-view eight-route desktop/mobile light/dark browser matrix passed exact canonical, non-empty H1, all JSON-LD, footer `data-nosnippet`, internal links, actual theme class, index/noindex expectation, branch-aware copy, zero horizontal overflow, and zero page, console, failed-request, or HTTP 4xx/5xx errors. The 12 initially premature location screenshots were replaced after slow-scroll reveal with zero remaining opacity-zero motion sections; independent visual review passed the replacements, while its earlier pass covered the other 20 captures, leaving all 32 free of material missing content, blank regions, clipping, overflow, contrast, theme, or layout defects. `lastmod` evidence is 2026-08-28 for `/`, `/medical-certificate`, `/medical-certificate-online`, `/about`, and `/contact`, and 2026-08-29 for `/telehealth-australia` plus all seven indexed location pages. All four generated aggregate audit artifacts had zero `paidRate` references and passed a zero-match privacy scan for raw query keys, UUIDs, email addresses, click identifiers, certificate credentials, and auth-token keys. The artifacts and screenshots were moved to Trash, the temporary env link was removed, port 3060 and all agent-browser sessions were closed, and the isolated tree was clean. No push or deployment occurred. Hosted exact-SHA behaviour, a fresh Google recrawl/index change, actual Google snippet/sitelink or SERP movement, and post-deploy revenue impact or causality remain unverified. | Independent base-to-receipt review before any PR or production action |
