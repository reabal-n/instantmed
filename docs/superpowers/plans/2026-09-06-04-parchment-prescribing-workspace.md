...
**Release:** protected merge, required CI on the final follow-up head, production deployment and smoke pending. Rollback is the runtime PR revert; no data/schema rollback is required.
