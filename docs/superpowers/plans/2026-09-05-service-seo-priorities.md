...
**Status, reconciled 2026-09-06:** The initial on-site batch is merged in PR #518 and included in the verified current production release. The nine-page query/link inventory and five service briefs are complete; the public change clarifies only the UTI and new/switch pill child pages. Public crawl repair is verified. Both prescription-page Search Console Live Tests passed on September 5; `/prescriptions` indexing was requested and the existing `/online-prescriptions` request was confirmed. Actual indexing and outstanding page-specific GSC tasks remain separate evidence. External visibility, including prospect research and drafts, stays deferred. [Session 2](2026-09-06-02-certificate-revenue-recovery.md) owns the next commercial selection. The dated baseline/ledger below describes its observation time and must not cause shipped work or indexing submissions to be repeated.
