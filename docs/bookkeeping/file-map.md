...
>
> **Doc-surface count:** 139 `.md` files (as at 2026-09-27) per `scripts/doc-audit.sh` (which counts the root assistant docs, `wiki/*.md`, `docs/plans/**` working + archived plans, `docs/superpowers/plans/**`, `docs/superpowers/specs/**`, and `docs/reviews/INDEX.md` alongside the canonical satellites below; ignored `.superpowers/**` execution briefs, reports, and ledgers and project skill sources under `.agents/**` / `.claude/**` are excluded). Reconciled 2026-06-16: 97 -> 103 after adding the repo-owned InstantMed workflow skills; 103 -> 110 on 2026-06-26 after adding the 7 prescribing-rebuild + med-cert implementation plans; 110 -> 112 on 2026-07-01 after adding the root context glossary and first ADR for Google Ads retained-value bidding; reconciled to 115 on 2026-07-08 after excluding generated verification artifacts from `scripts/doc-audit.sh` and adding the GEO citation execution record; reconciled to 116 on 2026-07-09 after adding the intake drop-off final plan; reconciled to 118 on 2026-07-10 after adding the audit-remediation implementation program and the comparison-surface submission kit; reconciled to 119 on 2026-07-12 after adding the cleanup-and-scale roadmap; reconciled to 105 on 2026-07-14 after retiring 13 superseded plans and the obsolete load-test README; reconciled to 106 on 2026-07-19 after adding the lifecycle and dashboard execution plan; reconciled to 108 on 2026-07-20 after adding the privacy-safe flow-attribution design and implementation plan; reconciled to 109 on 2026-07-27 after adding the Google Ads Agent implementation plan; reconciled to 111 on 2026-07-30 after adding the AI/organic growth plan that supersedes the archived 07-24 organic plan; reconciled to 112 on 2026-07-30 after adding the P0.2 attribution-enum specification; reconciled to 113 on 2026-07-30 after adding the P0.1 outreach drafts; reconciled to 115 on 2026-08-05 after adding the review-destination-choice plan and the business-trends design doc; reconciled to 116 on 2026-08-06 after adding the repeat-Rx dedicated-service routing plan; reconciled to 117 on 2026-08-07 after adding the weight-loss launch plan; reconciled to 118 on 2026-08-11 after adding the safe-scale readiness remediation plan; reconciled to 119 on 2026-08-24 after adding the free-channel compounding and repeat-Rx conversion plan; reconciled to 120 on 2026-08-25 after adding the OpenSEO research workflow skill; reconciled to 121 on 2026-08-28 after adding the organic-authority revenue-compounding implementation plan; reconciled to 123 on 2026-08-28 after adding the specialty-profitability design and implementation plan; reconciled to 124 on 2026-08-28 after adding the AI Voice Secretary build plan; reconciled to 125 on 2026-09-03 after adding the revenue-first comprehensive audit; reconciled to 126 on 2026-09-04 after adding the scaling follow-up audit; reconciled to 127 on 2026-09-04 after adding the conversion-retention friction closure plan; reconciled to 129 on 2026-09-05 after adding the friction release readiness receipt and service SEO priorities work package; reconciled to 134 on 2026-09-06 after adding five sequential reliability, revenue and dashboard session plans; reconciled to 135 on 2026-09-08 after adding the Plan 2 specialty acquisition repair receipt; reconciled to 128 on 2026-09-08 after moving seven project skill sources to `.agents/skills`, which this document count excludes; reconciled to 139 on 2026-09-27 after adding the landing redesign spec, its research report and its implementation plan.
>
...
## .agents/skills/ — 7 workflow skills

These are the canonical InstantMed-specific agent workflows. Run `scripts/sync-agent-skills.sh` after edits to verify the project-local Claude links to the Codex source.

| File | Purpose | Pinned by |
|------|---------|-----------|
| [.agents/skills/instantmed-checkout-payment-review/SKILL.md](../../.agents/skills/instantmed-checkout-payment-review/SKILL.md) | Checkout, Stripe, refund, webhook, and payment-state safety review | `project-docs-drift-contract` |
| [.agents/skills/instantmed-clinical-safety-review/SKILL.md](../../.agents/skills/instantmed-clinical-safety-review/SKILL.md) | Clinical policy, intake safety, service launch, prescribing, and doctor-review safety review | `project-docs-drift-contract` |
| [.agents/skills/instantmed-doc-drift-repair/SKILL.md](../../.agents/skills/instantmed-doc-drift-repair/SKILL.md) | Documentation drift repair and source-of-truth routing | `project-docs-drift-contract` |
| [.agents/skills/instantmed-marketing-compliance-review/SKILL.md](../../.agents/skills/instantmed-marketing-compliance-review/SKILL.md) | Regulated marketing, SEO, ads, claims, and public-copy compliance review | `project-docs-drift-contract` |
| [.agents/skills/instantmed-openseo-research/SKILL.md](../../.agents/skills/instantmed-openseo-research/SKILL.md) | OpenSEO vendor gate, context projection, credit, and research-routing workflow | `project-docs-drift-contract` |
| [.agents/skills/instantmed-production-incident-review/SKILL.md](../../.agents/skills/instantmed-production-incident-review/SKILL.md) | Production incident, outage, stuck-intake, integration, and recovery review | `project-docs-drift-contract` |
| [.agents/skills/instantmed-ui-browser-verification/SKILL.md](../../.agents/skills/instantmed-ui-browser-verification/SKILL.md) | UI polish, patient/staff flow verification, browser proof, and visual QA | `project-docs-drift-contract` |
...
## docs/audits/ — 27 (historical + growth records)

September 10 added [profit-growth execution](../audits/2026-09-10-profit-growth-execution.md) and its [aggregate provider receipts](../audits/2026-09-10-profit-growth-receipts.json): exact Ads changes, profit-policy decision, AI-referral diagnosis, contribution observations and release evidence.

| File | Purpose |
|------|---------|
| [docs/audits/2026-09-04-scaling-audit.md](../audits/2026-09-04-scaling-audit.md) | Reconciled September 6 audit: verified shipped/open findings, corrected revenue evidence, retired speculative scaling/resend advice and links to the canonical session queue |
| [docs/audits/2026-09-03-comprehensive-audit.md](../audits/2026-09-03-comprehensive-audit.md) | Revenue-first comprehensive audit 2026-09-03: 12-category scorecard, Google Ads account audit at keyword and search-term level, retention and funnel leaks, ranked money plan, exact Ads change list, engineering tickets, reviewer constraints |
...
| File | Purpose |
|------|---------|
| [docs/superpowers/plans/2026-09-26-landing-masterpiece.md](../superpowers/plans/2026-09-26-landing-masterpiece.md) | Implementation plan and execution handoff for the landing redesign (homepage, medical certificate, prescriptions, shared chrome): foundations, a direction-proof gate with Rey, the full build, and release after the 7 October Ads checkpoint |
| [docs/superpowers/plans/2026-09-23-certificate-request-simplification.md](../superpowers/plans/2026-09-23-certificate-request-simplification.md) | Final revised certificate form proposal: correctness prerequisites, accessible first-screen release, CI/monitor coverage, smaller follow-up and measured rollout; awaiting owner review |
...
| [docs/superpowers/plans/2026-08-28-organic-authority-revenue-compounding.md](../superpowers/plans/2026-08-28-organic-authority-revenue-compounding.md) | Paced implementation plan for search-truth repair, post-crawl branded-search observation, one approval-gated employer-authority experiment, and winner-only free-channel revenue compounding |
| [docs/superpowers/plans/2026-08-28-specialty-profitability-rebuild.md](../superpowers/plans/2026-08-28-specialty-profitability-rebuild.md) | Fable-gated Hair Loss and ED profitability rebuild with sequential experience cohorts, no-friction invariants, and approval-gated paid controls |
| [docs/superpowers/plans/2026-09-04-conversion-retention-friction-closure.md](../superpowers/plans/2026-09-04-conversion-retention-friction-closure.md) | Proposed closure plan for hosted guest-payment proof, optional account access, conversion and refill measurement, certificate resend reliability, prescriptions indexing, and specialty friction |
| [docs/superpowers/plans/2026-09-05-service-seo-priorities.md](../superpowers/plans/2026-09-05-service-seo-priorities.md) | Service-focused SEO planning package: nine-page indexing ledger, five service briefs, qualified distribution, AI referral measurement, and preserved experiment windows |
| [docs/superpowers/plans/2026-09-06-01-checkout-data-reliability.md](../superpowers/plans/2026-09-06-01-checkout-data-reliability.md) | Session 1: reproduce checkout recovery, harden/verify historical encryption and repair monitoring evidence |
| [docs/superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md](../superpowers/plans/2026-09-06-02-certificate-revenue-recovery.md) | Session 2: fresh certificate revenue diagnosis, one justified intervention and measurement handoff |
...
| [docs/superpowers/specs/2026-08-28-specialty-profitability-rebuild-design.md](../superpowers/specs/2026-08-28-specialty-profitability-rebuild-design.md) | Hair Loss and ED rebuild contract for sequential profitable testing without added intake friction or weakened clinical controls |
| [docs/superpowers/specs/2026-09-26-landing-masterpiece-design.md](../superpowers/specs/2026-09-26-landing-masterpiece-design.md) | Approved landing redesign contract: colour worlds, owned illustrations, truthful live status, green moat badges, trust components and pre-cleared copy |

## docs/research/ — 1

| File | Purpose |
|------|---------|
| [docs/research/2026-09-26-premium-health-landing-pages.md](../research/2026-09-26-premium-health-landing-pages.md) | Six-stream research report on premium health landing-page craft that informs the landing redesign spec. Evidence, not policy. |
...
- [Action access and consent plan](../superpowers/plans/2026-09-15-action-access-and-consent.md) — verified source gaps, three bounded fixes and separate evidence/release gates.

## Review drafts

- [Google Ads hardening and A$30k cashflow plan](../plans/2026-09-23-google-ads-cashflow-30k-review-plan.md) — pending Opus 5.5 review; no implementation approval. Count reconciled from the previous expected 133 plus this plan.
