...
| [docs/plans/2026-08-07-weight-loss-launch-plan.md](../plans/2026-08-07-weight-loss-launch-plan.md) | Decision-gated weight-loss launch plan (Phases 1-5 blocked on five operator decisions D-A..D-E); Phase 0 compliance remediation shipped with it; no execution authority until ROADMAP + BUSINESS_PLAN change |
