...
| [docs/plans/2026-08-28-ai-voice-secretary-plan.md](../plans/2026-08-28-ai-voice-secretary-plan.md) | Reference-only implementation plan for Lena's Patient-only Medical Director message flow, admin inbox, public number replacement, privacy boundary, and release proof; pending Fable review |
