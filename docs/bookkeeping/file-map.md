...
| [docs/plans/2026-07-30-ai-organic-growth-plan.md](../plans/2026-07-30-ai-organic-growth-plan.md) | Reference-only AI/LLM-referral and organic growth research programme (supersedes the archived 07-24 organic plan); staged and gated, ROADMAP ranks 3 and 6 decide activation |
| [docs/plans/2026-07-30-attribution-enum-spec.md](../plans/2026-07-30-attribution-enum-spec.md) | P0.2 specification for the AI-source attribution enum + shared exact-match classifier; specification only, authorises no code or schema change. Records three live classifier defects and the Phase 0 AI-fetcher access audit |
| [docs/plans/2026-07-30-p0-1-outreach-drafts.md](../plans/2026-07-30-p0-1-outreach-drafts.md) | P0.1 listing/outreach drafts (MediCompare, Finder, Trustpilot, Wikidata, NHSD, GBP) held for individual operator send approval; nothing sent or published. Agents must not submit or edit these external properties |
