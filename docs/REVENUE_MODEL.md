...
For the Scripts cash break-even ceiling, click-attributed repeats inside the window understate repeat value because most repeat orders come back direct. The ceiling therefore also recognises the 60-day repeat cash of the campaign's matured first-order cohort: campaign-attributed first orders paid 60 to 150 days before the window end, and every later purchase by those patients on any channel within 60 days, at exact cash-ledger value less actual fees (estimated only where a fee was never synced), expressed per first order. The ceiling takes the larger of the window's campaign cash and the first-order cash plus that measured repeat value, applies only with at least 20 matured first orders, and always stays under the 50% step.
...
**Delegated ceiling decision — later on 2026-09-19:** the operator delegated the next Women's Health ceiling to the agent ("do what's best for the business"). Decision: raise the code-owned Women's Health ceiling to AUD 75/day (`POLICY.womensHealth.dailyBudgetCents` 5,000 → 7,500 cents) ahead of the 2026-09-22 read, because Women's Health is the best-margin lane (Aug 20–Sep 18: AUD 490.12 spend, 19 orders, AUD 406.61 campaign contribution, 44% margin, AUD 377.47 first-order contribution) and was rank-limited, not budget-limited, before the AUD 4 bid change. This is a ceiling, not a budget change: the live budget stays AUD 50/day until the two-day read shows attributed orders and contribution holding, and any step to AUD 75/day is its own exact, approved proposal under the same review criteria.
