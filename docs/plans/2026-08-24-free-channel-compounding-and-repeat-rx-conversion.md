...
- **Item 2 shipped 2026-08-25** (PR #496, bounded `/prescriptions` answer-density session). The landing page and FAQPage schema now expose the full nine-question service-level FAQ, including timing through the approved `availability_24_7` claim and why prescribing requests require Medicare details. No drug names, guarantee, or new URL was added. The §3 gate remains unchanged: read two closed 30-day post-ship windows, continue at ≥8 free-channel paid orders, hold at 6-7, and stop at ≤5. No second copy session is authorised before that readout.
