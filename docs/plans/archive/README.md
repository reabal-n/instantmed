...
| 2026-07-12-cleanup-and-scale-roadmap.md | Superseded 2026-07-12 by the reconciled canonical `docs/ROADMAP.md`. Its proposed demand/cleanup order must not be executed directly. |
| 2026-07-24-organic-free-revenue-20k-plan.md | Superseded 2026-07-30 by `docs/plans/2026-07-30-ai-organic-growth-plan.md`. Retained for its baseline arithmetic and settled findings (§2) only. Its `$20k/mo free by Jan` goal and `$4k` free-channel fail line are NOT canon — `docs/ROADMAP.md` §2 owns the active `$5,000/month` net-retained rung. Do not execute from this plan. |
| 2026-08-04-review-destination-choice-plan.md | Blocked as written by external review 2026-08-07 (non-joinable evidence conflated as a funnel; capability key in a rendered URL; unsupported completion-rate claims). Superseded by the shipped inline two-destination choice on the post-delivery cards (#441): allowlisted destination token on /api/review-redirect, selection shares only, email stays ProductReview-direct. Do not execute the interstitial or its workstreams. |
