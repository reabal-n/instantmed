...
**F1. `/medical-certificate` — 10.4 screens measured against a 10.0 budget.**
...
**F2. `/erectile-dysfunction` — 10.7 screens measured against a 9.5 budget.**
...
**F3. `/hair-loss` — 12.0 screens measured against a 9.5 budget.**
