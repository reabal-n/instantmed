...
**Candidate packet; no production apply authorization or execution.** The corrected guard was independently reviewed at `f7ef38a25f8427f60461a0780e623d0f0fd5aa61`; integration head `4d23c5118c45ff3d41a91eb9f2ae9194ec8b1092` retains the identical repair patch. Script blob: `33c3d84005130ad734ccc3187d1b678e73ada785`; fixture-classifier blob: `866e75ca1db588bbf0a47963a774ad3c4529f676`. Final main-based [CI 34029654838](https://github.com/reabal-n/instantmed/actions/runs/34029654838) passed build, required E2E and Lighthouse on exact head `6b8d8eb6fd6f18dba41efba50aa3e335101a9023`; final integration review also passed. PR #528 merged at 12:27:10 UTC as `b8951b8366814e60d895f264ec533798179ce5a5`. The primary alias matched READY deployment `dpl_2fd3sLY6oYcL32ubERGuy4fgiT3X` at 12:29:35.422 UTC; [post-deploy smoke 34033255415](https://github.com/reabal-n/instantmed/actions/runs/34033255415) passed. These are tooling release receipts, not historical-data execution. The original two-scan race was reproduced in both HTTP and PostgreSQL: one preflight candidate became two updated rows. The frozen-scope correction passes 146 HTTP/PostgreSQL cases, including equal-count substitutions and refused zero-change reruns. No production backfill used the old CLI.

The reviewed CLI ran read-only at **2026-09-06 10:34:06.360–10:34:07.402 UTC** against Supabase project **`witzcrovsoumktyndqgz`** (`instantmed`, `ap-southeast-2`). A fresh run on the exact CI-passing `6b8d8eb6fd6f18dba41efba50aa3e335101a9023` at **11:54:31.384–11:54:32.364 UTC** matched every aggregate and the unchanged frozen scope fingerprint below, with zero writes/status rows. The current Vercel production environment supplied the three required variables from an empty directory, with inherited repair variables removed and no local dotenv fallback. The key authenticated **319/319** existing ciphertexts. This verifies production control-plane key compatibility; running function memory was not introspected.
