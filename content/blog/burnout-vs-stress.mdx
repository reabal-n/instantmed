...
relatedServices:
  ...
  - title: "GP Consultation"
    ...
    icon: consult
seo:
  title: "Burnout vs Stress: Signs, Causes and Recovery | InstantMed"
  description: "Stress responds to rest. Burnout does not. Recognise the signs, understand the stages, and know when to see a doctor. Medical certificates available."
  keywords:
    - "burnout vs stress"
    - "burnout symptoms"
...
- Habitual burnout - if unaddressed, burnout becomes embedded. [Depression](/conditions/depression), anxiety, or other mental health conditions may develop. Recovery requires more significant intervention
...
- Seek professional support - a GP can assess your overall health, screen for co-existing depression or anxiety, and provide a [medical certificate](/medical-certificate) for leave. A psychologist can help with cognitive patterns and coping strategies
