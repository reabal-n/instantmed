...
Proton pump inhibitors (PPIs) are the most effective acid-reducing medications, blocking acid production at the source. They are used for moderate to severe GERD and typically taken once daily before breakfast. PPIs are available on [prescription](/prescriptions) and some lower-dose versions are available over the counter.
