...
viewCount: 0
author: default
heroImage: "/images/blog/uti-antibiotics-online-australia/uti-online-suitability-map.webp"
heroImageAlt: "UTI antibiotic suitability depends on symptoms and risk factors. Typical urinary symptoms may fit remote review, but fever, flank pain, pregnancy, men, children, and recurrent symptoms change the route."
faqs:
  ...
  - question: "Is a UTI antibiotic prescription covered by the PBS?"
    answer: "Yes. Trimethoprim, nitrofurantoin, cefalexin, and amoxicillin-clavulanate are all PBS-listed. With a Medicare card you pay up to $25.00 per item (general patient) or $7.70 (concession card holder). Without Medicare, you pay the unsubsidised price, typically $15-30 for these medications. PBS pricing applies regardless of whether the prescription was issued via telehealth or an in-person GP."
...
Urinary tract infections are the most common reason Australians seek same-day antibiotic prescriptions via telehealth. For uncomplicated lower UTIs in non-pregnant women, an online doctor can assess your symptoms and issue an eScript to your phone within hours - no waiting room, no GP appointment.
...
## Pharmacist UTI Prescribing: Another Option for Eligible Women

Beyond telehealth, community pharmacist prescribing for uncomplicated UTIs has expanded across Australia. Under state and territory rules, a trained pharmacist can supply antibiotics for an uncomplicated lower UTI directly - without a doctor's prescription - for eligible people, generally non-pregnant women within a set age range who have a clear, uncomplicated presentation.

The eligibility limits mirror the telehealth ones: pharmacy UTI services exclude men, children, pregnancy, recurrent UTIs, and anyone with red flags such as fever or flank pain. If you do not meet the criteria, the pharmacist will refer you to a doctor. It is a convenient option for a straightforward UTI and sits alongside telehealth and GP care - it does not replace medical review when the picture is not simple.
...
1. **Start your consultation.** Choose a telehealth service that handles prescription requests and complete its structured symptom and medical history form - this takes around 5-10 minutes.
...
3. **Doctor review.** An AHPRA-registered doctor reviews your submission, typically within 1-2 hours. They assess whether antibiotic prescribing is appropriate and select the correct antibiotic, dose, and duration based on your individual history.
...
|---|---|---|
| Trimethoprim 300mg | General patient | Up to $25.00 |
| Trimethoprim 300mg | Concession | Up to $7.70 |
| Nitrofurantoin 100mg MR | General patient | Up to $25.00 |
| Nitrofurantoin 100mg MR | Concession | Up to $7.70 |

Source: PBS fees, patient contributions and Safety Net thresholds, current from 1 January 2026. Exact prices depend on the specific product dispensed and whether a brand substitution applies. Most first-line UTI antibiotics are inexpensive generic medicines.
...
- [Therapeutic Guidelines (eTG): Antibiotic](https://www.tg.org.au)
...
- [Department of Health, Disability and Ageing: PBS co-payments](https://www.health.gov.au/cheaper-medicines/pbs-co-payments)
