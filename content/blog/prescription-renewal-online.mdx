...
**Cardiovascular:**
Antihypertensives (ramipril, perindopril, amlodipine, irbesartan, metoprolol, telmisartan, candesartan), statins (atorvastatin, rosuvastatin), antiplatelet medications (low-dose aspirin), rate control medications for atrial fibrillation (stable patients).

**Endocrine:**
Metformin, SGLT2 inhibitors (empagliflozin, dapagliflozin), GLP-1 receptor agonists for established patients, levothyroxine (where recent TFTs are available), combined oral contraceptives, progestogen-only pill.

**Mental health (for established patients):**
SSRIs (sertraline, escitalopram, fluoxetine), SNRIs (venlafaxine, duloxetine), some other antidepressants for stable patients.
