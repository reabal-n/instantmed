...
**Endocrine (renewals):** Metformin and other diabetes medications, levothyroxine (where recent TFTs are available), contraceptives.

**Mental health medications (renewals):** SSRIs, SNRIs, and other antidepressants for established patients; mood stabilisers for stable patients with monitoring current.
