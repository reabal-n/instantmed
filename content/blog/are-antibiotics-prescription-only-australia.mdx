...
subtitle: "Yes. Systemic antibiotics are Schedule 4 prescription-only medicines under the TGA Poisons Standard. Here is what that means and why the rule exists."
excerpt: "Systemic antibiotics in Australia require a prescription under Schedule 4 of the TGA Poisons Standard. This guide explains what that means, why the rule exists, and why self-treatment is unsafe."
...
faqs:
  - question: "Are all antibiotics prescription-only in Australia?"
    answer: "Yes. Systemic antibiotics in Australia are Schedule 4 (prescription-only) medicines under the TGA Poisons Standard. You cannot buy them at a pharmacy without a valid prescription from an authorised prescriber. There are no over-the-counter antibiotic options for internal use."
  ...
  - question: "Can a telehealth doctor prescribe antibiotics?"
    answer: "Yes, when remote assessment is clinically appropriate and the prescriber has enough information to make a safe decision. The clinical standard is the same as for an in-person consultation. Some infections still need examination, testing, or urgent in-person care."
  ...
  - question: "Can I get antibiotics without seeing a doctor?"
    answer: "No. Systemic antibiotics require assessment by an authorised prescriber. Remote assessment may be suitable for some low-risk presentations, but it is still a medical assessment, not over-the-counter access."
  - question: "What should I do with leftover antibiotics?"
    answer: "Do not keep or reuse them. Leftover antibiotics may be the wrong medicine, an incomplete course, expired, or unsafe for your current situation. Return unused antibiotics to a pharmacy for safe disposal."
relatedArticles:
...
seo:
  ...
  description: "Yes - systemic antibiotics in Australia are Schedule 4 prescription-only medicines under the TGA Poisons Standard. Learn why the rule exists and why self-treatment is unsafe."
  keywords:
...
Yes. Systemic antibiotics in Australia are Schedule 4 (prescription-only) medicines under the Therapeutic Goods Administration (TGA) Poisons Standard. You cannot buy oral or injectable antibiotics at a pharmacy without a valid prescription from an authorised prescriber, regardless of whether you have taken the same medication before or believe your condition is straightforward.

This article explains what Schedule 4 means in practice, why antibiotics are controlled this way, what a safe prescribing pathway involves, and why self-treatment with leftovers or unregulated online products is risky.

<Callout variant="info">Direct answer: systemic antibiotics in Australia require a prescription. They are classified as Schedule 4 (prescription-only) medicines under the TGA Poisons Standard because they need clinical oversight.</Callout>
...
## How Antibiotic Prescribing Works in Australia

Because antibiotics require a prescription, they need assessment by an authorised prescriber. The right pathway depends on the infection, severity, risk factors, and whether examination or testing is needed.
...
Telehealth prescribing can be appropriate for conditions where remote clinical assessment is sufficient. This can include uncomplicated urinary tract infections in adult women, some skin infections assessable from photographs, and bacterial sinusitis meeting specific criteria.
...
Long-term or prophylactic antibiotic use, such as some acne or recurrent UTI prevention plans, should be managed with continuity and periodic review rather than treated as a routine repeat without reassessment.
...
Most commonly prescribed antibiotics are listed on the Pharmaceutical Benefits Scheme (PBS). With a valid Medicare card, you pay the standard PBS co-payment regardless of whether the prescription came from an in-person GP or an appropriate telehealth assessment.
...
For conditions suitable for remote assessment, telehealth may be a legitimate prescribing pathway. For conditions requiring physical examination, testing, or urgent treatment, an in-person GP, after-hours clinic, or emergency pathway is the safer option.
