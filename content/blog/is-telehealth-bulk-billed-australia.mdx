...
seo:
  ...
  description: "Most telehealth is not bulk billed. Medicare requires an existing GP relationship. Learn what you pay, when rebates apply, and why private telehealth exists."
  keywords:
...
<Callout variant="info">Direct answer: Most telehealth appointments are not bulk billed. Medicare telehealth rebates require an existing GP relationship - you must have seen the GP (or a GP at the same practice) within the past 24 months. Without this, telehealth is private and you pay the full consultation fee out of pocket.</Callout>
