...
When you submit your request, it enters a doctor-owned clinical pathway. Eligible low-risk requests may be issued under that protocol and are individually reviewed afterward; requests outside the protocol require clinician review before a decision. AI does not prescribe or make independent clinical decisions.
