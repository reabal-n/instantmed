...
Using a legitimate [telehealth medical certificate](/medical-certificate) service, one that conducts a genuine clinical assessment, uses AHPRA-registered practitioners, and displays registration details on documents, gives the certificate a much stronger basis if it is questioned.
