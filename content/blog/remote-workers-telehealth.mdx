...
The Royal Flying Doctor Service (RFDS) provides essential primary and emergency care to remote Australia, but it is designed for emergencies and chronic disease management, not for the routine healthcare needs that telehealth can address - like a [medical certificate](/medical-certificate) for a stomach bug, a prescription renewal for blood pressure medication, or advice about a [skin rash](/conditions/skin-rash) that has been bothering you for a week.
