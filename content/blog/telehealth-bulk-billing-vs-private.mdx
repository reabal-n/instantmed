...
The right choice depends on urgency, access, and your individual circumstances. For a non-urgent condition where you have a bulk-billing GP, book with them. For same-day needs - a [certificate](/medical-certificate), a [prescription](/prescriptions) running out, advice at 11pm - an asynchronous private service is usually faster and more accessible.
