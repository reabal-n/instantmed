...
viewCount: 0
author: default
heroImage: "/images/blog/repeat-prescription-online-australia/repeat-prescription-review-map.webp"
heroImageAlt: "A repeat prescription still needs a safety review. The doctor checks stability, medicine history, contraindications, interactions, and whether usual follow-up is due."
faqs:
...
## Why a Repeat Request Might Be Declined
...
- The medication needs monitoring - for example a blood test for thyroid medication, kidney function for some blood pressure medicines, or levels for lithium - and your results are overdue.
- Your condition appears to have changed, or you describe new or worsening symptoms that need assessment first.
- The request is for a Schedule 8 controlled medicine, which generally cannot be prescribed this way.
- You are asking for a dose change, a new medication, or a switch, which usually needs a fuller consultation.
- There is no record of a recent face-to-face review and the medicine needs periodic in-person oversight.
- Safety information is missing - allergies, pregnancy or breastfeeding status, or other current medicines - and cannot be clarified.
