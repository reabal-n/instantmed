...
export const workplaceArticles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'heading', content: 'University vs. Workplace: What\'s Different', level: 2 },
      { type: 'table', content: '', headers: ['Requirement', 'Workplace', 'University'], rows: [
        ['Diagnosis disclosed?', 'No - "unfit for work" is sufficient', 'Sometimes - severity or impact may be required'],
        ['Timing', 'After the fact is usually fine', 'Certificate should be dated close to the affected assessment'],
        ['Specific forms?', 'Rarely', 'Often - many unis have their own forms'],
        ['Online certificates accepted?', 'Yes', 'Generally yes - check your university\'s policy'],
        ['Retrospective certificates?', 'Sometimes', 'Harder to obtain - see a doctor while unwell'],
      ]},
      ...
      { type: 'paragraph', content: 'Special consideration is for circumstances beyond your control that affected assessment performance. Common qualifying reasons:' },
      ...
      { type: 'steps', content: '', items: [
        'See a doctor close to when you are affected - not weeks later. The certificate needs to be contemporaneous.',
        'Keep copies of all documentation including the certificate and your submission confirmation.',
        'Submit applications within your university\'s timeframe - late applications are often not accepted.',
        'Be honest about how your condition affected your study - examiners are experienced at assessing these claims.',
        'Do not wait until results come out to apply - this raises questions about whether the illness really impacted performance.',
      ]},
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'table', content: '', headers: ['Illness', 'Typical time off', 'Return notes'], rows: [
        ['Common cold', '2-5 days', 'Often return earlier with lingering symptoms - if productive, that\'s fine'],
        ['Influenza (flu)', '7-14 days', 'Fever-free for 24 hours before returning'],
        ['Gastroenteritis', '1-3 days after symptoms stop', 'Food handlers: 48 hours symptom-free before returning (legal requirement)'],
        ['COVID-19', '5-7 days typically', 'Follow current health authority guidelines'],
        ['Surgery (minor)', '3-14 days', 'Follow your surgeon\'s specific advice'],
        ['Mental health', 'Varies by situation', 'Discuss phased return with your doctor'],
      ]},
      ...
      { type: 'paragraph', content: 'Some jobs require a doctor\'s clearance before returning, especially after extended absence, in safety-critical roles, food handling after gastro, or healthcare settings. A telehealth doctor can provide a fitness-for-work certificate.' },
      { type: 'heading', content: 'Phased Return Options', level: 2 },
      { type: 'steps', content: '', items: [
        'Talk to your employer before returning - discuss what you can manage and agree on an initial schedule.',
        'Start with reduced hours if you are not yet at full energy. Half days are better than pushing through and relapsing.',
        'Use working from home for the first few days if available - removes commute fatigue and lets you rest when needed.',
        'Take on modified or lighter duties initially, avoiding high-pressure tasks until you feel fully recovered.',
        'Gradually increase your workload over 1-2 weeks as your energy returns, adjusting if needed.',
      ]},
