...
export const seoArticles: Article[] = [
  ...
  // ============================================
  {
    ...
    content: [
      ...
      { type: 'paragraph', content: 'Online medical certificates are appropriate for many common conditions that don\'t require physical examination. These include cold and flu symptoms, gastroenteritis, migraines, back pain, mental health days, period pain, and recovery from minor illness. If your condition needs hands-on assessment, a good telehealth service will tell you.', links: [{ text: 'mental health days', href: '/blog/medical-certificate-mental-health-day', title: 'Medical certificates for mental health' }, { text: 'migraines', href: '/conditions/migraine', title: 'Migraine symptoms and treatment' }, { text: 'back pain', href: '/conditions/back-pain', title: 'Back pain causes and management' }, { text: 'period pain', href: '/conditions/period-pain', title: 'Period pain information' }] },
