...
export const seoArticles: Article[] = [
  ...
  // ============================================
  {
    ...
    content: [
      ...
      { type: 'callout', variant: 'info', content: 'Quick answer: Yes, online medical certificates are legally valid in Australia. Employers cannot reject a certificate solely because it was issued via telehealth.' },
      { type: 'heading', content: 'Online vs In-Person: How They Compare', level: 2 },
      { type: 'table', content: '', headers: ['Feature', 'Online (Telehealth)', 'In-Person GP'], rows: [
        ['Availability', '24/7, any day', 'Appointment required, business hours'],
        ['Wait time', 'Under 30 minutes', '1-7+ days for an appointment'],
        ['Certificate validity', 'Legally identical', 'Legally identical'],
        ['Diagnosis disclosed', 'No (by law)', 'No (by law)'],
        ['Cost', 'From $19.95', '$30-$90 out of pocket'],
        ['Physical exam', 'Not possible', 'Available if needed'],
      ]},
      { type: 'heading', content: 'How to Get a Medical Certificate Online: Step by Step', level: 2 },
      { type: 'steps', content: '', items: [
        'Complete a brief health questionnaire describing your symptoms - takes about 3 minutes.',
        'Provide your details: name, date of birth, and employer name if required by your workplace.',
        'An AHPRA-registered doctor reviews your information and assesses your condition.',
        'If clinically appropriate, the doctor approves and signs your certificate digitally.',
        'Your certificate arrives via email or SMS - forward it straight to your employer.',
      ]},
      { type: 'heading', content: 'What Conditions Can Be Covered?', level: 2 },
      { type: 'paragraph', content: 'Online medical certificates are appropriate for many common conditions that don\'t require a physical examination. Doctors assess each situation individually - the following are typical, not guaranteed.', links: [{ text: 'back pain', href: '/conditions/back-pain', title: 'Back pain causes and management' }, { text: 'migraines', href: '/conditions/migraine', title: 'Migraine symptoms and treatment' }, { text: 'period pain', href: '/conditions/period-pain', title: 'Period pain information' }] },
      { type: 'table', content: '', headers: ['Condition', 'Online suitable?', 'Notes'], rows: [
        ['Cold and flu', 'Yes', 'Very common, no exam needed'],
        ['Gastroenteritis', 'Yes', 'Symptom-based assessment'],
        ['Mental health day', 'Yes', 'Stress, anxiety, burnout'],
        ['Migraines', 'Yes', 'Established condition'],
        ['Back pain', 'Yes', 'Non-acute, no injury'],
        ['Period pain', 'Yes', 'Ongoing condition'],
        ['Ear infection', 'Possibly', 'May need in-person if severe'],
        ['Chest infection', 'Possibly', 'Depends on severity'],
        ['Broken bone / injury', 'No', 'Physical exam required'],
      ]},
      { type: 'heading', content: 'Is It Legal? What the Law Says', level: 2 },
      { type: 'paragraph', content: 'Yes. Telehealth prescribing and certification by AHPRA-registered doctors is fully legal under Australian health law. The Fair Work Act 2009 requires employees to provide "evidence that would satisfy a reasonable person" - and a telehealth certificate from a registered doctor meets this standard.' },
      { type: 'callout', variant: 'tip', content: 'Your employer cannot legally require you to disclose your specific diagnosis. The certificate confirms you are unfit for work - nothing more.' },
      { type: 'heading', content: 'When to See a Doctor In Person', level: 2 },
      { type: 'list', content: '', items: [
        'Severe or rapidly worsening symptoms',
        'You need a physical examination (ear infections, chest sounds, wounds)',
        'You require urgent or emergency care - call 000',
        'Extended illness without improvement after several days',
        'The telehealth doctor recommends in-person follow-up',
      ]},
      { type: 'callout', variant: 'warning', content: 'For emergencies - chest pain, difficulty breathing, severe allergic reactions - call 000 immediately. Do not use telehealth in an emergency.' },
    ],
    faqs: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'callout', variant: 'info', content: 'Quick answer: Yes, online prescriptions are legal in Australia. AHPRA-registered doctors can prescribe most common medications via telehealth, and eScripts work at any Australian pharmacy.' },
      { type: 'heading', content: 'How Online Prescriptions Work: Step by Step', level: 2 },
      { type: 'steps', content: '', items: [
        'Submit your request online - describe your condition, current medication, and medical history. Takes about 5 minutes.',
        'An AHPRA-registered doctor reviews your information and makes a clinical prescribing decision.',
        'If appropriate, the doctor issues an eScript - an electronic prescription sent via SMS to your phone.',
        'Take the SMS QR code to any pharmacy in Australia. They scan it and dispense your medication.',
        'Medication is PBS-subsidised if applicable - same as a standard paper prescription.',
      ]},
      { type: 'heading', content: 'What Can (and Can\'t) Be Prescribed Online', level: 2 },
      { type: 'paragraph', content: 'Most common ongoing medications can be prescribed via telehealth. The main exception is Schedule 8 controlled drugs, which require in-person consultation under Australian law.' },
      { type: 'table', content: '', headers: ['Medication type', 'Online prescribing', 'Notes'], rows: [
        ['Blood pressure medications', 'Yes', 'Ongoing treatment'],
        ['Cholesterol (statins)', 'Yes', 'Ongoing treatment'],
        ['Diabetes medications', 'Yes', 'Ongoing treatment'],
        ['Asthma preventers', 'Yes', 'Ongoing treatment'],
        ['Contraceptives', 'Yes', 'Most types'],
        ['Antibiotics', 'Yes', 'When clinically indicated'],
        ['Skin treatments', 'Yes', 'Non-urgent conditions'],
        ['Mental health medications', 'Yes', 'Established treatment, not new starts for all'],
        ['Strong opioid painkillers', 'No', 'Schedule 8 - in-person required'],
        ['ADHD medications', 'No', 'Schedule 8 - specialist required'],
        ['New medications (no diagnosis)', 'No', 'In-person assessment needed first'],
      ]},
      { type: 'heading', content: 'eScripts: How They Work at the Pharmacy', level: 2 },
      { type: 'paragraph', content: 'An eScript is an electronic prescription that replaces the old paper script. When approved, you receive an SMS with a unique QR code. Show this to any pharmacist - they scan it, verify your identity, and dispense your medication. The process is identical to a paper prescription, just faster.', links: [{ text: 'electronic prescription', href: '/blog/how-escripts-work', title: 'How eScripts work in Australia' }] },
      { type: 'callout', variant: 'tip', content: 'Your eScript QR code is single-use. Keep the SMS until you\'ve collected your medication. For repeat prescriptions, you\'ll receive a new code each time.' },
      { type: 'heading', content: 'When to See a Doctor In Person', level: 2 },
      { type: 'list', content: '', items: [
        'New medications for an undiagnosed condition - a physical assessment is needed first',
        'Schedule 8 controlled drugs (opioids, ADHD medications)',
        'Medications requiring blood tests, monitoring, or specialist oversight',
        'Complex drug interactions or changes to multiple medications',
        'Your condition is worsening or not responding to current treatment',
      ]},
      { type: 'callout', variant: 'info', content: 'Telehealth prescribing rules vary by state and medication. A responsible service will always tell you if your medication cannot be prescribed online.' },
    ],
    faqs: [
  ...
  },
  {
    ...
    content: [
      { type: 'paragraph', content: 'When your prescription repeats run out and your GP is booked for weeks, telehealth offers a practical solution. For medications you\'re already taking, an online doctor can review your history and issue a new prescription - often the same day, without an appointment.', links: [{ text: 'telehealth', href: '/blog/what-is-telehealth', title: 'What is telehealth?' }] },
      { type: 'callout', variant: 'info', content: 'Quick answer: Yes. Telehealth doctors can issue repeat prescriptions for most ongoing medications. eScripts are sent to your phone and work at any Australian pharmacy.' },
      { type: 'heading', content: 'How to Renew Your Prescription Online', level: 2 },
      { type: 'steps', content: '', items: [
        'Find your medication packaging - you\'ll need the exact name, strength, and dose. This makes the doctor\'s review faster.',
        'Submit your request online with your medication details and a brief medical history.',
        'An AHPRA-registered doctor reviews your request - typically within 1-2 hours during operating hours.',
        'If approved, your eScript arrives via SMS. Show the QR code at any pharmacy to collect your medication.',
      ]},
      { type: 'heading', content: 'Which Medications Can Be Renewed Online?', level: 2 },
      { type: 'paragraph', content: 'Online repeat prescriptions work best for stable, ongoing medications you\'ve been taking without issues. The doctor needs confidence your condition is stable and the medication is still appropriate for you.', links: [{ text: 'high cholesterol', href: '/conditions/high-cholesterol', title: 'High cholesterol management' }, { text: 'thyroid issues', href: '/conditions/thyroid-issues', title: 'Thyroid condition information' } ] },
      { type: 'table', content: '', headers: ['Medication type', 'Online renewal', 'Notes'], rows: [
        ['Blood pressure medications', 'Yes', 'Stable, ongoing treatment'],
        ['Cholesterol (statins)', 'Yes', 'Stable, ongoing treatment'],
        ['Thyroid medications', 'Yes', 'If stable and recently reviewed'],
        ['Contraceptive pill', 'Yes', 'Most oral contraceptives'],
        ['Asthma preventers', 'Yes', 'Not reliever-only treatment'],
        ['Antidepressants', 'Yes', 'Established treatment, stable dose'],
        ['Metformin (diabetes)', 'Yes', 'Ongoing treatment'],
        ['Opioid painkillers', 'No', 'Schedule 8 - in-person required'],
        ['ADHD medications', 'No', 'Schedule 8 - specialist required'],
        ['New medications', 'No', 'Needs initial in-person assessment'],
      ]},
      { type: 'callout', variant: 'tip', content: 'Have your current medication packaging within reach when submitting. Exact name, strength, and dose speeds up the doctor\'s review significantly.' },
      { type: 'heading', content: 'Telehealth vs Your Regular GP: When to Use Each', level: 2 },
      { type: 'table', content: '', headers: ['Situation', 'Telehealth repeat', 'See your GP'], rows: [
        ['Running out of stable medication', 'Yes', '-'],
        ['GP booked for 2+ weeks', 'Yes', '-'],
        ['No side effects or concerns', 'Yes', '-'],
        ['Side effects or changes in condition', '-', 'Yes'],
        ['Due for blood tests or monitoring', '-', 'Yes'],
        ['Starting a new medication', '-', 'Yes'],
        ['Annual medication review', '-', 'Yes'],
      ]},
      { type: 'heading', content: 'Keeping Your Regular GP in the Loop', level: 2 },
      { type: 'paragraph', content: 'Telehealth repeats are a bridge, not a replacement. Most medications benefit from an annual review with a GP who knows your full history - especially if your dose, health, or other medications have changed. Use telehealth when you need it, but keep your regular GP relationship active.' },
