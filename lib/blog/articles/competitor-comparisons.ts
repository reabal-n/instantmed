  ...
  // Article 1: Best Online Doctor Services in Australia
  {
    ...
    content: [
      ...
      },
      {
        type: 'table',
        content: '',
        headers: ['Provider', 'Model', 'Pricing', 'Best for'],
        rows: [
          ['InstantMed', 'Async (form-based), no appointment', 'Med certs from $19.95, scripts from $29.95, consults from $49.95', 'Medical certificates, repeat scripts, quick consults - no subscription'],
          ['InstantConsult', 'Video with scheduled appointments', '~$35-55 per consult', 'Real-time video interaction, traditional GP experience online'],
          ['Rosemary Health', 'Prescription-focused, subscription model', '~$30-60 per consult', 'Ongoing weight management, hair, skin, and ED treatment pathways'],
          ...
          ['Youly', "Women's health focused", 'Varies', "Contraception, UTI treatment, women's health services"],
          ['HotDoc', 'GP booking platform with telehealth', "Your GP's rates", 'Seeing your regular GP online without a new service'],
        ],
      },
      {
        type: 'heading',
      ...
      },
      {
        type: 'table',
        content: '',
        headers: ['What you need', 'Best option'],
        rows: [
          ['Medical certificate for work or study', 'Generalist service - InstantMed or InstantConsult'],
          ['Repeat prescription for a stable medication', 'Any generalist telehealth provider (not controlled substances)'],
          ['Ongoing treatment for weight, hair, skin, or ED', 'Subscription service - Rosemary Health or Eucalyptus'],
          ['Video consultation with a doctor', 'InstantConsult or your GP via HotDoc'],
          ['See your regular GP online', 'HotDoc'],
          ["Women's health services", 'Youly or Kin (Eucalyptus)'],
          ['Urgent or complex situation', 'See a GP in person or call 000 for emergencies'],
        ],
      },
      {
        type: 'heading',
  ...
  // Article 2: InstantMed vs Going to the GP
  {
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ['Bulk-billed GP', 'Free to patient', 'Increasingly hard to find in metro areas; many practices have shifted to private billing'],
          ['Private GP (with Medicare)', '$60-120 total; ~$20-80 out of pocket', 'Medicare rebates ~$41 for a standard consult; some practices charge more'],
          ['After-hours GP clinic', '$40-100+ out of pocket', 'Higher gap payments than standard GP visits'],
          ['InstantMed medical certificate', '$19.95-$39.95 (1-3 days)', 'No Medicare rebate; often less than a private GP gap payment'],
          ['InstantMed repeat prescription', '$29.95', 'No Medicare rebate; predictable flat fee'],
          ['InstantMed general consultation', '$49.95', 'Comparable to private GP gap payment for straightforward issues'],
          ['Specialised InstantMed consultations', '$49.95-$89.95', 'Competitive with private GP pricing for equivalent services'],
        ],
      },
      {
        type: 'callout',
      ...
      },
      {
        ...
        rows: [
          ['Regular GP check-ups (annual or as recommended)', 'See your GP'],
