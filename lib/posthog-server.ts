...
export function trackBusinessMetric(event: {
  metric: 'payment_failed' | 'queue_backup' | 'sla_breach' | 'certificate_error' | 'email_delivery_failed' | 'high_risk_intake' | 'ahpra_reverification_overdue' | 'email_bounced' | 'email_stuck_pending' | 'daily_reconciliation' | 'stuck_awaiting_script'
