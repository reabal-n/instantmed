...
export const WEIGHT_LOSS_ONLINE_FAQ = [
  ...
  {
    question: "Why does this page avoid naming prescription-only options?",
    answer:
  ...
  {
    question: "What information does a doctor usually need for weight management?",
    answer:
  ...
  {
    question: "When is online-only care not suitable?",
    answer:
  ...
  {
    question: "Is weight management covered by Medicare or the PBS?",
    answer:
  ...
  {
    question: "Are prescriptions guaranteed after a weight management assessment?",
    answer:
  ...
  {
    question: "What red flags should not wait for an online form?",
    answer:
