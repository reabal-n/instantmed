...
export const MED_CERT_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Medical certificate requests can be submitted 24/7 and are reviewed by a doctor after submission. If the doctor needs more information, they\u2019ll message you through our secure platform. In rare cases, a quick phone call may be needed.",
  },
  {
