...
export const SEEDED_E2E_PRESCRIBING_PATIENT_PROFILE_ID = "e2e00000-0000-0000-0000-000000000090"
export const SEEDED_E2E_GUEST_PATIENT_PROFILE_ID = "e2e00000-0000-0000-0000-0000000000a1"
export const SEEDED_E2E_AUTO_APPROVAL_PATIENT_PROFILE_ID = "e2e00000-0000-0000-0000-0000000000a2"
export const SEEDED_E2E_BATCH_REVIEW_PATIENT_PROFILE_ID = "e2e00000-0000-0000-0000-0000000000a3"

export const SEEDED_E2E_PATIENT_PROFILE_IDS = [
  SEEDED_E2E_PATIENT_PROFILE_ID,
  SEEDED_E2E_PRESCRIBING_PATIENT_PROFILE_ID,
  SEEDED_E2E_GUEST_PATIENT_PROFILE_ID,
  SEEDED_E2E_AUTO_APPROVAL_PATIENT_PROFILE_ID,
  SEEDED_E2E_BATCH_REVIEW_PATIENT_PROFILE_ID,
] as const
