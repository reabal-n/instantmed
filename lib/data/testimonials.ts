...
export const TESTIMONIALS: Testimonial[] = [
  ...
  // uni mid-semester
  {
    ...
    service: "medical-certificate",
    verified: true,
    image: "https://api.dicebear.com/7.x/notionists/svg?seed=AidenK",
    featured: true,
  },
  // uni TAFE
  {
    ...
    age: 22,
    rating: 5,
    text: "TAFE requires a cert within 7 days of absence. Got mine online from my couch. Way less stressful than trying to get a same-day appointment.",
    date: "5 days ago",
    service: "medical-certificate",
    verified: true,
    image: "https://api.dicebear.com/7.x/notionists/svg?seed=JasmineP",
  },
  // carer's leave
  {
    id: "t53",
  ...
  // work sick day - shift worker
  {
    ...
    age: 27,
    rating: 5,
    text: "I work shifts so GP hours are basically useless to me. Sorted my cert at 11:30pm after a night shift. Exactly what I needed.",
    date: "4 days ago",
    service: "medical-certificate",
    verified: true,
    image: "https://api.dicebear.com/7.x/notionists/svg?seed=DylanF",
  },
  // mental health / personal day
  {
    id: "t55",
    name: "Rachel M.",
    location: "Glebe, NSW",
    ...
    service: "medical-certificate",
    verified: true,
    image: "https://api.dicebear.com/7.x/notionists/svg?seed=RachelM",
  },
  {
    id: "t19",
    name: "Sophie T.",
    ...
    age: 33,
    rating: 5,
    text: "Ran out of my regular medication while travelling. Got a new script sent to a local pharmacy after doctor approval - really took the stress out of it.",
    date: "5 days ago",
  ...
  // === PRESCRIPTIONS / REPEAT MEDICATIONS ===
  {
    ...
    age: 52,
    rating: 5,
    text: "Needed my regular medication renewed. Sorted online after doctor approval. Usually takes a week just to get a GP appointment.",
    date: "1 week ago",
    service: "prescription",
    verified: true,
  ...
  },
  {
    ...
    age: 29,
    rating: 5,
    text: "On holiday and ran out of my regular medication. New script sent to a local pharmacy after doctor approval. Huge relief.",
    date: "1 week ago",
    service: "prescription",
    verified: true,
