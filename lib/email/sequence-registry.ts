...
export const EMAIL_SEQUENCES: readonly EmailSequenceDefinition[] = [
  ...
  },
  {
    ...
    status: "active",
    owner: "Founder ops",
    trigger: "Business and queue summary",
    cadence: "Daily",
    guard: "Outbox idempotency key per recipient/day",
  },
  {
    id: "ops_email_digest",
    ...
    trigger: "Deliverability summary",
    cadence: "Weekly",
    guard: "Outbox idempotency key per recipient/week",
  },
  {
