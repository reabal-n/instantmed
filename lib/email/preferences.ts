...
/**
 * Resolve a patient's marketing-email preference without collapsing an
 * infrastructure failure into a policy decision.
 */
...
/**
 * Backward-compatible boolean gate for existing callers. Transient preference
 * failures remain fail-closed, but detailed callers can now retry them.
 */
