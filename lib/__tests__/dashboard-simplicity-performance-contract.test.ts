...
describe("dashboard simplicity and runtime performance contracts", () => {
  ...
  it("keeps clinical action colours muted on the doctor surface", () => {
    ...
    const dashboardLayoutSource = read("components/operator/staff-layout.tsx")
    ...
    expect(dashboardLayoutSource).toContain("getStaffDisplayRole(profile)")
  ...
  it("keeps the review pane decision controls visible before scrolling", () => {
    ...
    // Note content, whitespace and auto-height behavior are covered by the
    // clinical-case-review renderer, soap-note tests and clinical-review E2E.
  ...
  it("keeps the patient profile drawer as a fast reference surface", () => {
    ...
    expect(source).toContain('title="Prior activity"')
