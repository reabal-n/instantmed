...
describe("dashboard simplicity and runtime performance contracts", () => {
  ...
  it("keeps the doctor queue header focused on current operational pressure", () => {
    ...
    expect(queueClientSource).toContain("Open the case to see ${nextPatientFirstName}'s details.")
    expect(queueClientSource).toContain("Open {nextPatientFirstName}'s case")
  ...
  it("keeps clinical action colours muted on the doctor surface", () => {
    ...
    expect(actionButtonsSource).toContain("refundConsequenceLabel")
    expect(actionButtonsSource).toContain("If you decline, ${patientFirstName || \"the patient\"} is refunded ${refundShortLabel}.")
    expect(actionButtonsSource).toContain("data-refund-consequence")
    expect(actionButtonsSource.indexOf("data-refund-consequence")).toBeGreaterThan(actionButtonsSource.indexOf("data-decline-action"))
    expect(actionButtonsSource).not.toContain("Declining refunds")
    ...
    expect(actionButtonsSource).toContain("const completedChecks")
    ...
    expect(actionButtonsSource).toContain(".map((check)")
    ...
    expect(actionButtonsSource).toContain('tone="tertiary"')
  ...
  it("keeps the review pane decision controls visible before scrolling", () => {
    ...
    expect(reviewPanelSource).toContain("Doctor review follows when available.")
    ...
    expect(clinicalCaseReviewSource).toContain("Visible to you before send. Press Cmd+Enter to approve.")
