...
describe("dashboard simplicity and runtime performance contracts", () => {
  ...
  it("keeps the doctor queue header focused on current operational pressure", () => {
    ...
    expect(queueClientSource).toContain("onOpenNext")
    expect(queueClientSource).toContain("Open {nextPatientFirstName")
    ...
    expect(queueClientSource).toContain("is next.")
  ...
  it("keeps the form-to-inbox metric real-only and med-cert scoped", () => {
    ...
    expect(queueClientSource).toContain("Timing shown in queue header.")
  ...
  it("keeps clinical action colours muted on the doctor surface", () => {
    ...
    expect(actionButtonsSource).toContain("Decline refunds")
    ...
    expect(actionButtonsSource).toContain("Checks complete")
    ...
    expect(actionButtonsSource).not.toContain("sticky bottom-0")
    ...
    expect(actionButtonsSource).toContain("text-slate-700")
    expect(actionButtonsSource).toContain("bg-rose-500")
