...
describe("dashboard simplicity and runtime performance contracts", () => {
  ...
  it("keeps the doctor queue header focused on current operational pressure", () => {
    ...
    expect(queueClientSource).toContain('import { IntakeReviewPanel } from "@/components/doctor/intake-review-panel"')
    expect(queueClientSource).not.toContain("primeReviewPanelCode")
  ...
  it("keeps split-view loading and row chrome calm under interaction", () => {
    ...
    expect(queueTableSource).not.toContain("onPrimeReviewPanelCode")
    expect(queueClientSource).toContain("data-review-pane-entry")
    expect(reviewPanelSource).toContain("review-pane-in_280ms")
    expect(reviewPanelSource).toContain('data-testid="intake-review-loading"')
    expect(reviewPanelSource).toContain("data-review-skeleton-reserved")
    expect(reviewPanelSource).toContain("sm:grid-cols-2")
