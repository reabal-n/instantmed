...
describe("dashboard simplicity and runtime performance contracts", () => {
  ...
  it("keeps the doctor queue header focused on current operational pressure", () => {
    ...
    expect(queueClientSource).toContain("Cases finished today")
    ...
    expect(queueClientSource).toContain("Cases finished today")
    expect(queueClientSource).toContain("Target used")
    expect(queueClientSource).toContain("of the 2-hour target.")
    ...
    expect(queueFiltersSource).toContain("Median form-to-inbox today")
