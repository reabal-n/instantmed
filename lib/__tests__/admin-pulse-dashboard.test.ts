...
describe("admin pulse dashboard", () => {
  it("keeps the default admin page as a unified staff cockpit", () => {
    ...
    const ownerSetupCard = readProjectFile("components/admin/owner-operator-setup-card.tsx")
    ...
    expect(page).toContain("OwnerOperatorSetupCard")
    expect(page).toContain("StaffCommandPalette")
    expect(page).toContain("Resume reviewing")
    expect(page).toContain('buildAdminDashboardHref({ status: "review", anchor: "doctor-queue" })')
    expect(page).toContain("parchmentUserId")
    expect(page).toContain("doctorAvailable={doctorAvailable}")
    ...
    expect(ownerSetupCard).toContain("Provider number")
    expect(ownerSetupCard).toContain("AHPRA")
    expect(ownerSetupCard).toContain("Signature")
    expect(ownerSetupCard).toContain("Parchment")
    expect(ownerSetupCard).toContain("MFA")
    expect(ownerSetupCard).toContain("ADMIN_DOCTOR_IDENTITY_HREF")
