...
describe("repeat script schema — dedicated-service routing", () => {
  ...
  it("refuses weight medicines at checkout even with stale diabetes exemptions", () => {
    for (const name of ["Mounjaro", "Monjaro", "Wegovy", "Ozempic", "Ozemptic", "Duromine", "Duramine", "Trulicity", "dulaglutide", "GLP-1", "Phentermine", "Metermine", "semaglutide", "tirzepatide", "triztepide", "liraglutide", "Saxenda", "Victoza", "Rybelsus", "Zepbound"]) {
