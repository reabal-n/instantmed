...
export const intentPages: IntentPage[] = [
  ...
  medCertPage({
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "text",
        content: "The certificate follows a doctor-owned issue pathway with individual review. It is not a downloadable blank note or self-declared form.",
      },
      {
        id: "red-flags",
        title: "Red flags",
  ...
  cityMedCertPage({
    ...
    answer: "Perth patients can request a medical certificate online for short illness or carer leave through a doctor-owned issue pathway with individual review.",
