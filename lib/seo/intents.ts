...
export const intentPages: IntentPage[] = [
  medCertPage({
    ...
    description: `Request a same day medical certificate online from ${PRICING_DISPLAY.MED_CERT}. Bounded clinical pathway, secure PDF delivery after approval.`,
    h1: "Same day medical certificate online",
    answer: `Yes. You can request a same day medical certificate online for short illness or carer leave. ${CLINICAL_REVIEW_SEQUENCE}`,
    intro: "Start with a short secure form and confirm your absence dates. Your answers help determine whether an online certificate is suitable.",
    ...
    blocks: [
      ...
      {
        id: "doctor-check",
        title: "What the pathway checks",
        type: "text",
        content: "The pathway checks symptoms, onset, requested dates, role or study demands, and whether your situation needs doctor or in-person care instead.",
      },
      {
        id: "boundary",
    ...
    faqs: [
      { question: "Can I request it today?", answer: `Yes. The form can be started any time. ${CLINICAL_REVIEW_SEQUENCE}` },
  ...
  medCertPage({
    ...
    description: `Request a medical certificate for work online from ${PRICING_DISPLAY.MED_CERT}. Bounded clinical pathway, secure PDF after approval.`,
    ...
    faqs: [
      { question: "Will my employer decide whether it is enough?", answer: "Your employer can assess evidence under workplace policy. InstantMed provides clinically assessed documentation, not a promise about every workplace rule." },
      { question: "Can I use it for carer leave?", answer: "Yes, through the carer's leave option when the request fits the routine certificate pathway." },
      { question: "Can I request multiple days?", answer: "You can request one, two, or three days. Concerning or uncertain requests go to a doctor before issue." },
    ],
  }),
  medCertPage({
    priority: 3,
    ...
    description: `Request an online sick certificate from ${PRICING_DISPLAY.MED_CERT}. Bounded clinical pathway, Australia only, secure delivery after approval.`,
    h1: "Online sick certificate",
    answer: `An online sick certificate is a medical certificate requested through telehealth. ${CLINICAL_REVIEW_SEQUENCE}`,
    ...
    blocks: [
      {
        ...
        content: [
          ...
          "The bounded clinical pathway issues a secure PDF if approved.",
        ],
      },
      {
        id: "not-a-template",
        ...
        type: "text",
        content: "The certificate follows a doctor-owned clinical pathway. It is not a downloadable blank note or self-declared form.",
      },
      {
        id: "red-flags",
        title: "Red flags",
    ...
    faqs: [
      { question: "Is this just a form?", answer: `No. The form collects clinical details for the bounded pathway. ${CLINICAL_REVIEW_SEQUENCE}` },
  ...
  medCertPage({
    ...
    description: `Need a one day certificate? Request a clinically assessed medical certificate online from ${PRICING_DISPLAY.MED_CERT}.`,
    h1: "One day medical certificate online",
    answer: `A one day medical certificate request is the simplest InstantMed certificate option and costs ${PRICING_DISPLAY.MED_CERT}. Your request is assessed for suitability.`,
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "text",
        content: "Your request asks for the exact date. The pathway assesses whether that date is supported by the information provided; uncertainty goes to a doctor.",
      },
      {
  ...
  medCertPage({
    ...
    description: `Request a two day medical certificate online from ${PRICING_DISPLAY.MED_CERT_2DAY}. Bounded clinical pathway before issue.`,
    h1: "Two day medical certificate online",
    answer: `You can request a two day medical certificate online for ${PRICING_DISPLAY.MED_CERT_2DAY}. Your request is assessed for suitability.`,
  ...
  medCertPage({
    ...
    description: `Request a medical certificate for cold or flu symptoms online from ${PRICING_DISPLAY.MED_CERT}. Bounded clinical pathway.`,
    ...
    intro: "Use this page when a respiratory illness has kept you away from work or study and you need a simple clinically assessed evidence pathway.",
  ...
  medCertPage({
    ...
    description: `Request a student medical certificate online from ${PRICING_DISPLAY.MED_CERT}. Bounded short-absence clinical pathway.`,
    ...
    intro: "Use this when illness has affected attendance or participation and you need clinically assessed documentation.",
  ...
  medCertPage({
    ...
    description: `Shift worker unwell? Request a clinically assessed medical certificate online from ${PRICING_DISPLAY.MED_CERT}.`,
  ...
  comparisonPage({
    ...
    answer: "An online certificate is medical evidence issued after telehealth assessment. It is best for short, non-urgent absences where the bounded pathway is clinically suitable.",
    ...
    ctaUrl: "/request?service=med-cert",
    blocks: [
      { id: "what-it-is", title: "What it is", type: "text", content: `The request is assessed remotely through a doctor-owned clinical pathway. ${CLINICAL_REVIEW_SEQUENCE}` },
    ...
    faqs: [
      { question: "Is the pathway doctor-owned?", answer: `Yes. It is governed by an AHPRA-registered Medical Director. ${CLINICAL_REVIEW_SEQUENCE}` },
  ...
  comparisonPage({
    ...
    blocks: [
      ...
      { id: "instantmed-position", title: "InstantMed position", type: "callout", content: "InstantMed optimises for short, clear, clinically assessed requests and explains the service and its limits before payment." },
    ],
    faqs: [
