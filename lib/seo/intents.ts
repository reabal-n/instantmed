...
export const intentPages: IntentPage[] = [
  medCertPage({
    ...
    intro: "Start with a short secure form and confirm your absence dates. Routine requests follow the bounded certificate protocol; concerns go to a doctor.",
  ...
  medCertPage({
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "text",
        content: "The certificate follows a doctor-owned clinical pathway. Routine requests may issue under protocol; it is not a downloadable blank note or self-declared form.",
      },
      {
        id: "red-flags",
        title: "Red flags",
  ...
  medCertPage({
    ...
    answer: `A one day medical certificate request is the simplest InstantMed certificate option and costs ${PRICING_DISPLAY.MED_CERT}. Routine requests may follow the bounded protocol; concerns go to a doctor.`,
  ...
  medCertPage({
    ...
    answer: `You can request a two day medical certificate online for ${PRICING_DISPLAY.MED_CERT_2DAY}. Routine requests may follow the bounded protocol; concerns go to a doctor.`,
