...
intentPages.push(
  {
    slug: 'online-doctor-prescription',
    title: 'Online Doctor Prescription | Get a Script Without Visiting GP',
    description: 'Get prescriptions online from Australian doctors. Repeat scripts, new prescriptions, and ongoing medication management via telehealth.',
    ...
    intent: {
      ...
      alternateQueries: [
        ...
        'online script',
        'doctor prescription without appointment',
        'e-prescription online',
      ],
      userNeed: 'Get a prescription without visiting a GP in person',
      urgency: 'same-day',
      conversionGoal: 'Start consultation',
    },
    content: {
    ...
    faqs: [
      {
        question: 'Can I get any medication prescribed online?',
        answer: 'Most medications can be prescribed online except Schedule 8 controlled substances (opioids, stimulants, strong sleeping pills). First-time prescriptions for some medications may require in-person GP visit.',
      },
      {
        question: 'How long does it take to get my prescription?',
        answer: 'Standard consultations are reviewed within 24 hours. Priority reviews are completed within 30 minutes for urgent needs.',
      },
      {
        question: 'Do I need a previous prescription to get a repeat?',
        answer: 'For repeat prescriptions, it helps to have your previous script or medication details, but it is not always required. We can look up your medication history.',
      },
    ],
  },
  {
    slug: 'antibiotics-online',
    title: 'Antibiotics Online | Get Antibiotic Prescription From Australian Doctor',
    description: 'Get antibiotics prescribed online for UTI, bacterial infections, and more. Fast consultation with Australian GP. E-prescription in 30 minutes.',
    keywords: ['antibiotics online', 'antibiotic prescription', 'UTI antibiotics', 'online antibiotics Australia'],
    type: 'intent',
    intent: {
      primaryQuery: 'antibiotics online',
      alternateQueries: [
        'get antibiotics without seeing doctor',
        'antibiotic prescription online',
        'UTI antibiotics online',
        'online doctor antibiotics',
      ],
      userNeed: 'Get antibiotics quickly without in-person GP visit',
      urgency: 'same-day',
      conversionGoal: 'Start consultation',
    },
    content: {
      intro: 'Get antibiotics prescribed online by Australian doctors for urinary tract infections, respiratory infections, skin infections, and more. Fast consultation with e-prescription sent directly to your phone.',
      sections: [
        {
          heading: 'What infections can be treated online?',
          content: 'Australian doctors can prescribe antibiotics online for uncomplicated UTIs, simple skin infections, respiratory tract infections, and some sexually transmitted infections. Complex or severe infections require in-person assessment.',
        },
        {
          heading: 'How do I get antibiotics online?',
          content: 'Complete an online consultation describing your symptoms. An Australian doctor reviews your case and determines if antibiotics are appropriate. If prescribed, you receive an e-prescription within 30 minutes (priority) or 24 hours (standard).',
        },
        {
          heading: 'Are online antibiotics safe?',
          content: 'Yes. InstantMed doctors follow Australian antibiotic prescribing guidelines and antimicrobial stewardship principles. We only prescribe antibiotics when clinically appropriate and after thorough assessment.',
        },
      ],
    },
    faqs: [
      {
        question: 'Can I get antibiotics online without seeing a doctor?',
        answer: 'No. In Australia, antibiotics are prescription-only. You must consult with a doctor (online or in-person) who will assess whether antibiotics are medically appropriate.',
      },
      {
        question: 'What if the doctor says I don\'t need antibiotics?',
        answer: 'Many infections are viral and do not require antibiotics. The doctor will explain this and provide advice on symptom management. You are not charged if the doctor declines your request.',
      },
      {
        question: 'How quickly can I start taking antibiotics?',
        answer: 'With priority review, you can have your e-prescription within 30 minutes and pick up antibiotics from any pharmacy immediately.',
      },
    ],
  },
  {
    slug: 'morning-after-pill-online',
    title: 'Morning After Pill Online | Emergency Contraception Consultation',
    description: 'Get the morning after pill (emergency contraception) prescribed online. Fast Australian doctor consultation. Priority review available.',
    keywords: ['morning after pill', 'emergency contraception', 'Plan B online', 'levonorgestrel', 'emergency contraceptive'],
    type: 'intent',
    intent: {
      primaryQuery: 'morning after pill online',
      alternateQueries: [
        'emergency contraception online',
        'Plan B online',
        'day after pill',
      ...
      userNeed: 'Get emergency contraception quickly',
      urgency: 'immediate',
      conversionGoal: 'Start urgent consultation',
    },
    content: {
      intro: 'Get the morning after pill prescribed online with priority consultation. Time is critical - emergency contraception is most effective when taken as soon as possible after unprotected sex.',
      sections: [
        {
          heading: 'How quickly can I get it?',
          content: 'Priority consultations are reviewed within 30 minutes. E-prescription is sent directly to your phone and can be filled at any Australian pharmacy immediately. The morning after pill is also available over the counter at pharmacies.',
        },
        {
          heading: 'How long do I have?',
          content: 'Levonorgestrel (Plan B) is effective up to 72 hours after unprotected sex. Ulipristal (EllaOne) can be used up to 120 hours. Both are most effective when taken as soon as possible.',
        },
        {
          heading: 'Do I need a prescription?',
          content: 'The morning after pill is available over the counter at Australian pharmacies, but an online consultation can provide guidance, answer questions, and provide a prescription if needed.',
        },
      ],
    },
    faqs: [
      {
        question: 'Can I buy the morning after pill without a doctor?',
        answer: 'Yes, the morning after pill is available over the counter at Australian pharmacies. An online consultation can provide guidance and prescription if needed.',
      },
      {
        question: 'Will it affect my fertility?',
        answer: 'No. Emergency contraception does not affect future fertility. It is a one-time hormonal intervention that delays ovulation.',
      },
      {
        question: 'Can I use it as regular birth control?',
        answer: 'No. The morning after pill is for emergency use only. For regular contraception, consider the contraceptive pill, IUD, or implant.',
      },
    ],
  },
  {
    slug: 'acne-treatment-online',
    title: 'Acne Treatment Online | Get Prescription Acne Medication From Doctor',
    description: 'Get acne medication prescribed online including doxycycline, topical treatments, and more. Australian doctors available for telehealth consultation.',
    keywords: ['acne treatment online', 'acne prescription', 'doxycycline for acne', 'online acne doctor'],
    type: 'intent',
    intent: {
      primaryQuery: 'acne treatment online',
      alternateQueries: [
        'online acne prescription',
        'doxycycline for acne',
        'prescription acne medication',
        'telehealth acne treatment',
      ],
      userNeed: 'Get prescription acne medication without GP visit',
      urgency: 'flexible',
      conversionGoal: 'Start consultation',
    },
    content: {
      intro: 'Get prescription acne treatment online from Australian doctors. We can prescribe oral antibiotics (doxycycline), topical treatments, and provide ongoing management for moderate to severe acne.',
      sections: [
        {
          heading: 'What acne treatments can be prescribed?',
          content: 'Australian doctors can prescribe oral antibiotics (doxycycline), topical retinoids, benzoyl peroxide combinations, and oral contraceptives for hormonal acne (women). Isotretinoin (Accutane) requires specialist referral.',
        },
        {
          heading: 'How long does acne treatment take?',
          content: 'Oral antibiotics like doxycycline take 6-12 weeks to show improvement. Treatment typically continues for 3-6 months. Topical treatments take 8-12 weeks. Acne management requires patience and consistency.',
        },
        {
          heading: 'Do I need photos of my acne?',
          content: 'Yes. Upload clear photos of your acne during the consultation so the doctor can assess severity and prescribe appropriate treatment.',
        },
      ],
    },
    faqs: [
      {
        question: 'Can I get Accutane (isotretinoin) online?',
        answer: 'No. Isotretinoin requires specialist dermatologist management due to serious side effects and pregnancy risks. We can provide a referral.',
      },
      {
        question: 'Will antibiotics cure my acne permanently?',
        answer: 'Antibiotics treat active acne but do not cure it permanently. After stopping antibiotics, maintenance treatment with topical products is usually needed.',
      },
      {
        question: 'Can I get acne treatment if I am pregnant?',
        answer: 'Some acne treatments are safe in pregnancy (e.g., certain topicals) but others are not (e.g., doxycycline, retinoids). The doctor will prescribe pregnancy-safe options.',
      },
    ],
  },
  {
    slug: 'reflux-treatment-online',
    title: 'Reflux Treatment Online | Heartburn & GERD Medication Prescription',
    description: 'Get reflux medication prescribed online including PPIs, H2 blockers, and more. Australian doctor consultation for acid reflux and heartburn.',
    keywords: ['reflux treatment online', 'heartburn medication', 'GERD treatment', 'omeprazole online', 'PPI prescription'],
    type: 'intent',
    intent: {
      primaryQuery: 'reflux treatment online',
      alternateQueries: [
        'heartburn medication online',
        'GERD treatment online',
        'omeprazole prescription online',
        'acid reflux doctor online',
      ],
      userNeed: 'Get prescription reflux medication for ongoing symptoms',
      urgency: 'same-day',
      conversionGoal: 'Start consultation',
    },
    content: {
      intro: 'Get prescription reflux medication online from Australian doctors. We prescribe proton pump inhibitors (PPIs), H2 blockers, and provide ongoing management for acid reflux, heartburn, and GERD.',
      sections: [
        {
          heading: 'What medications can be prescribed?',
          content: 'Australian doctors can prescribe PPIs (omeprazole, esomeprazole, pantoprazole), H2 blockers (ranitidine alternatives), and antacids. We also provide lifestyle advice for reflux management.',
        },
        {
          heading: 'When should I see a GP in person?',
          content: 'See a GP in person if you have: difficulty swallowing, unexplained weight loss, vomiting blood, severe chest pain, or symptoms not responding to treatment. These may indicate serious conditions requiring investigation.',
        },
        {
          heading: 'How long will I need to take medication?',
          content: 'Most people need 4-8 weeks of PPI treatment for symptom relief. Some require long-term treatment. Lifestyle modifications (weight loss, dietary changes) can reduce medication needs.',
        },
      ],
    },
    faqs: [
      {
        question: 'Can I take PPIs every day long-term?',
        answer: 'PPIs can be used long-term but require periodic review. Long-term use (>1 year) carries risks of vitamin B12 deficiency, low magnesium, and bone fractures. Discuss with your doctor.',
      },
      {
        question: 'Why are my symptoms worse after stopping PPIs?',
        answer: 'Rebound acid hypersecretion can occur when stopping PPIs suddenly after long-term use. Taper off gradually under doctor guidance rather than stopping abruptly.',
      },
      {
        question: 'Are there natural alternatives to PPIs?',
        answer: 'Lifestyle changes can help: elevate head of bed, avoid trigger foods, eat smaller meals, lose weight if overweight, avoid eating before bed. These work best combined with medication initially.',
      },
    ],
  },
)
