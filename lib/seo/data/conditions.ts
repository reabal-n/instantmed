...
export const conditionsData: Record<string, ConditionData> = {
  ...
  asthma: {
    ...
    treatmentInfo: {
      overview: "Asthma treatment follows a stepwise approach: reliever inhalers for acute symptoms and preventer inhalers for ongoing control. Most Australians with asthma over-rely on relievers and under-use preventers. If you need your reliever more than twice per week, your asthma is not well controlled and you need a preventer.",
      medications: [
        {
          genericName: "Salbutamol",
          brandNames: ["Ventolin", "Asmol"],
      ...
      guidelineSource: "Therapeutic Guidelines - Respiratory, 2024",
      whenToSeeSpecialist: "Referral to a respiratory physician is recommended if asthma is not controlled despite combination preventer therapy, if you have had a life-threatening asthma attack, if the diagnosis is uncertain, or for consideration of biologic therapies for severe asthma.",
    },
    reviewedDate: "2026-03",
  },
  "cold-sores": {
