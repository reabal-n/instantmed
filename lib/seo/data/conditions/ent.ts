...
export const entConditions: Record<string, ConditionData> = {
  ...
  "ear-infection": {
    ...
    treatmentInfo: {
      overview: "Ear infection treatment depends on the type and severity. Otitis externa (outer ear) is treated with topical antibiotic ear drops. For otitis media (middle ear), most cases in adults are viral or resolve spontaneously -- analgesia and watchful waiting for 48-72 hours is recommended by eTG before prescribing antibiotics. Antibiotics are indicated for: severe pain, fever over 39 degrees C, bilateral otitis media, or lack of improvement after 48-72 hours of observation. Ciprofloxacin is not used for middle ear infections (reserved for outer ear and perforated drum with discharge).",
      medications: [
        {
          genericName: "Ibuprofen + paracetamol (alternating)",
          brandNames: ["Nurofen", "Panadol"],
          drugClass: "NSAID + analgesic combination",
          typicalDose: "Ibuprofen 400mg and paracetamol 1g alternating every 3 hours; follow individual maximum daily doses",
          pbsListed: false,
          pbsNote: "Available OTC without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Alternating paracetamol and ibuprofen provides superior analgesia to either alone for ear pain",
            "Take ibuprofen with food; ensure max daily paracetamol is not exceeded (4g/day)",
            "Often sufficient as sole treatment for mild otitis media during the watchful waiting period",
          ],
        },
        {
          genericName: "Ciprofloxacin + dexamethasone ear drops",
          brandNames: ["Cilodex", "Cipromed"],
          ...
          availableOnline: true,
          keyPoints: [
            "First-line treatment for otitis externa (swimmer's ear) per eTG ENT guidelines",
            "Dexamethasone component reduces the inflammation and oedema in the ear canal",
            "More effective and less resistance concern than aminoglycoside drops (framycetin combinations)",
            "A telehealth consult can prescribe for classic otitis externa presentations",
          ],
        },
        {
          ...
          availableOnline: true,
          keyPoints: [
            "First-line antibiotic for bacterial otitis media when treatment is indicated per eTG",
            "Indicated after 48-72 hours of watchful waiting without improvement, or immediately for severe cases",
            "If penicillin allergy: cefalexin or roxithromycin are alternatives per eTG",
            "Can be prescribed via telehealth when clinical picture is consistent with bacterial otitis media",
          ],
        },
      ],
      guidelineSource: "Therapeutic Guidelines -- Ear, Nose and Throat, 2023; Australian Society of Clinical and Experimental Immunology guidelines for ear infections",
      whenToSeeSpecialist: "Refer urgently if: mastoiditis suspected (swelling or redness behind the ear, displaced pinna), facial nerve palsy, suspected cholesteatoma, or severe vertigo with hearing loss. Refer to an ENT specialist for: recurrent otitis media (3 or more episodes in 6 months), persistent middle ear fluid (glue ear) for more than 3 months, or hearing loss not resolved after treatment.",
    },
    reviewedDate: "2026-03",
  },
  "sore-throat": {
    ...
    treatmentInfo: {
      overview: "Most sore throats are viral (70-85% in adults) and do not require antibiotics. The eTG recommends using the modified Centor score to guide antibiotic prescribing: a score of 3-4 (fever, tonsillar exudate, tender anterior cervical lymph nodes, absence of cough, plus age 15-44 years) suggests possible Group A Streptococcus and may warrant treatment. Phenoxymethylpenicillin (penicillin V) is first-line for confirmed or likely strep. Amoxicillin is equally effective but should not be used when glandular fever (EBV) is suspected as it causes a maculopapular rash in that context.",
      medications: [
        {
          genericName: "Ibuprofen",
          brandNames: ["Nurofen", "Advil"],
          drugClass: "NSAID analgesic / anti-inflammatory",
          typicalDose: "400mg every 6-8 hours with food; maximum 1200mg per day OTC",
          pbsListed: false,
          pbsNote: "Available OTC without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Superior to paracetamol for sore throat pain due to anti-inflammatory mechanism targeting tonsillar inflammation",
            "Take with food; avoid in peptic ulcer disease, renal impairment, cardiovascular disease",
            "Combining with paracetamol (alternating) provides better pain control than either alone",
          ],
        },
        {
          genericName: "Benzydamine (topical)",
          brandNames: ["Difflam Spray", "Difflam Lozenges"],
          drugClass: "Topical non-steroidal anti-inflammatory",
          typicalDose: "Spray: 4-8 puffs onto throat every 1.5-3 hours; Lozenges: 1 lozenge every 2-3 hours",
          pbsListed: false,
          pbsNote: "Available OTC without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Provides direct local anti-inflammatory and anaesthetic effect on the throat",
            "Cochrane evidence supports topical benzydamine for reduction of sore throat pain and duration",
            "Particularly useful when swallowing oral analgesics is painful",
          ],
        },
        {
          genericName: "Phenoxymethylpenicillin (penicillin V)",
          brandNames: ["Cilicaine VK", "Abbocillin VK"],
          drugClass: "Penicillin antibiotic",
          ...
          availableOnline: true,
          keyPoints: [
            "First-line antibiotic for Group A Streptococcus sore throat per eTG -- narrows strep coverage, limits resistance",
            "10-day course is recommended to eliminate strep and reduce rheumatic fever risk (particularly important in Aboriginal and Torres Strait Islander communities)",
            "Do not use amoxicillin if glandular fever (EBV) is possible -- causes characteristic widespread rash",
            "A telehealth consult can assess modified Centor score and prescribe if bacterial strep is likely",
          ],
        },
      ],
      guidelineSource: "Therapeutic Guidelines -- Antibiotic, 2024; National Heart Foundation of Australia: Guideline for the diagnosis and management of acute rheumatic fever and rheumatic heart disease in Australia, 2020",
      whenToSeeSpecialist: "Refer urgently if: difficulty breathing, drooling (inability to swallow saliva), muffled 'hot potato' voice with asymmetric tonsillar swelling (peritonsillar abscess), or neck stiffness with high fever. Refer to ENT for: recurrent streptococcal pharyngitis (5 or more episodes per year), or consideration of tonsillectomy. Glandular fever (EBV) diagnosis and management can be initiated via telehealth with monospot test arranged at a pathology lab.",
    },
    reviewedDate: "2026-03",
  },
  conjunctivitis: {
    ...
    treatmentInfo: {
      overview: "Conjunctivitis treatment is type-specific. Viral conjunctivitis is self-limiting (resolves in 7-14 days) and requires no antibiotic treatment -- lubricating drops and hygiene measures are sufficient. Bacterial conjunctivitis typically produces mucopurulent (thick yellow-green) discharge and may benefit from topical antibiotics to shorten duration. Allergic conjunctivitis responds well to mast cell stabiliser or antihistamine eye drops. Topical antibiotics are grossly overprescribed for viral conjunctivitis in Australia, contributing to antimicrobial resistance without clinical benefit.",
      medications: [
        {
          genericName: "Carmellose sodium or polyvinyl alcohol (artificial tears)",
          brandNames: ["Systane", "Refresh", "Optive"],
          drugClass: "Lubricating eye drops",
          typicalDose: "1-2 drops in affected eye(s) as needed (every 1-4 hours)",
          pbsListed: false,
          pbsNote: "Available OTC without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "First-line for viral conjunctivitis symptom relief -- lubricates and flushes discharge",
            "No medicinal properties; safe for unlimited use",
            "Preservative-free formulations preferred if using more than 4 times per day",
          ],
        },
        {
          genericName: "Olopatadine hydrochloride (ophthalmic)",
          brandNames: ["Patanol", "Pazeo"],
          drugClass: "Antihistamine + mast cell stabiliser eye drops",
          typicalDose: "1 drop in affected eye(s) twice daily",
          pbsListed: false,
          pbsNote: "Available OTC (S3, pharmacist supply) without prescription; preferred over older antihistamine drops",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Most effective OTC option for allergic conjunctivitis -- dual mechanism reduces itch and discharge rapidly",
            "Provides relief within minutes; suitable for seasonal use alongside oral antihistamines",
            "Superior to non-dual-action drops (ketotifen, levocabastine) for combined itch and discharge symptoms",
          ],
        },
        {
          genericName: "Chloramphenicol (ophthalmic)",
          brandNames: ["Chlorsig", "Minims Chloramphenicol"],
          drugClass: "Topical broad-spectrum antibiotic eye drops",
          typicalDose: "1 drop in affected eye(s) every 2 hours while awake initially, reducing to 4 times daily; 5-7 day course",
          pbsListed: false,
          pbsNote: "Available OTC (S3, pharmacist supply) since TGA rescheduling; also available by prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "First-line topical antibiotic for bacterial conjunctivitis per eTG; broad-spectrum coverage of common pathogens",
            "Should only be used when bacterial cause is likely (thick mucopurulent discharge, unilateral, no itching)",
            "Avoid in viral and allergic conjunctivitis -- no benefit and contributes to resistance",
            "Rare risk of aplastic anaemia with prolonged systemic use; not a concern with short-course topical application",
          ],
        },
      ],
      guidelineSource: "Therapeutic Guidelines -- Eye, Ear, Nose and Throat, 2023; Royal Australian and New Zealand College of Ophthalmologists (RANZCO) conjunctivitis management guidelines",
      whenToSeeSpecialist: "Refer urgently to an ophthalmologist if: significant eye pain (not just irritation), photophobia, reduced visual acuity, white corneal opacity or infiltrate, contact lens wear with red eye (possible acanthamoeba keratitis), or neonatal conjunctivitis. Ophthalmology same-day referral for any suspected keratitis, uveitis, or acute glaucoma.",
    },
    reviewedDate: "2026-03",
  },
  "pink-eye": {
    ...
    treatmentInfo: {
      overview: "Pink eye (conjunctivitis) treatment mirrors the conjunctivitis page as they are the same condition. For viral pink eye: supportive care only (artificial tears, hygiene). For bacterial: topical chloramphenicol eye drops (OTC) shorten duration. For allergic: antihistamine or mast cell stabiliser eye drops. The majority of antibiotic prescribing for pink eye in Australia is unnecessary -- viral causes do not respond to antibiotics and should be managed with lubricating drops and hygiene.",
      medications: [
        {
          genericName: "Carmellose sodium (artificial tears)",
          brandNames: ["Systane", "Refresh", "Optive"],
          drugClass: "Lubricating eye drops",
          typicalDose: "1-2 drops in affected eye(s) every 1-4 hours as needed",
          pbsListed: false,
          pbsNote: "Available OTC without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "First-line for viral pink eye -- relieves gritty sensation and flushes discharge",
            "Safe to use as frequently as needed; preservative-free options available",
            "Cool drops from the refrigerator can provide additional soothing effect",
          ],
        },
        {
          genericName: "Olopatadine (ophthalmic)",
          brandNames: ["Patanol"],
          drugClass: "Antihistamine + mast cell stabiliser eye drops",
          typicalDose: "1 drop in each affected eye twice daily",
          pbsListed: false,
          pbsNote: "Available OTC (S3, pharmacist supply) without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Best OTC option for allergic pink eye -- faster and more complete itch relief than lubricating drops alone",
            "Works within minutes; safe for regular seasonal use",
          ],
        },
        {
          genericName: "Chloramphenicol (ophthalmic)",
          brandNames: ["Chlorsig"],
          drugClass: "Topical broad-spectrum antibiotic",
          typicalDose: "1 drop in affected eye(s) every 2 hours initially, then 4 times daily; 5-7 day course",
          pbsListed: false,
          pbsNote: "Available OTC (S3, pharmacist supply) without prescription",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Appropriate for bacterial pink eye with thick mucopurulent discharge -- reduces symptom duration",
            "Do not use for viral or allergic pink eye (no benefit, increases antibiotic resistance)",
            "If not improving after 48 hours of antibiotic drops, reassess for viral cause or alternative diagnosis",
          ],
        },
      ],
      guidelineSource: "Therapeutic Guidelines -- Eye, Ear, Nose and Throat, 2023; RANZCO Australian guidelines for conjunctivitis",
      whenToSeeSpecialist: "Seek same-day ophthalmology assessment if: eye pain beyond mild irritation, light sensitivity, visual disturbance, corneal opacity or redness, contact lens wear with red eye, or neonatal conjunctivitis. These can indicate serious conditions (keratitis, uveitis, iritis) requiring urgent specialist treatment.",
    },
    reviewedDate: "2026-03",
  },
  vertigo: {
    ...
    treatmentInfo: {
      overview: "Vertigo treatment is cause-specific. BPPV (the most common cause) is primarily treated with the Epley manoeuvre -- a specific series of head movements that repositions displaced otoconia in the semicircular canal. This is highly effective (70-90% success with one or two treatments). Vestibular neuritis (acute prolonged vertigo) is treated with vestibular suppressants for the acute phase (48-72 hours), followed by vestibular rehabilitation exercises. Meniere's disease requires long-term management including betahistine. Medications are not a substitute for vestibular rehabilitation in BPPV.",
      medications: [
        {
          ...
          availableOnline: true,
          keyPoints: [
            "First-line vestibular suppressant for acute vertigo with nausea per eTG -- particularly vestibular neuritis",
            "Buccal tablet formulation is useful when swallowing is difficult due to nausea and vomiting",
            "Use for maximum 3 days only -- prolonged vestibular suppression delays central compensation and recovery",
            "Can be prescribed via telehealth for acute vestibular neuritis presentations",
          ],
        },
        {
          genericName: "Betahistine",
          brandNames: ["Serc", "Betahistine Sandoz"],
          ...
          availableOnline: true,
          keyPoints: [
            "Used for long-term management of Meniere's disease to reduce frequency and severity of attacks",
            "Evidence is mixed for BPPV; not recommended as primary BPPV treatment",
            "Must be taken regularly for ongoing Meniere's prophylaxis -- not a rescue medication for acute attacks",
            "A telehealth consult can initiate betahistine for patients with confirmed or likely Meniere's",
          ],
        },
        {
          ...
          availableOnline: true,
          keyPoints: [
            "Alternative vestibular suppressant with additional sedating and antiemetic properties",
            "Useful when vertigo is preventing sleep during the acute phase",
            "Significant sedation -- do not drive; use at night preferentially",
            "Limit to short-term use (2-3 days); prolonged use delays vestibular compensation",
          ],
        },
      ],
      guidelineSource: "Therapeutic Guidelines -- Neurology, 2023; Cochrane Review: Particle repositioning manoeuvres for benign paroxysmal positional vertigo (2022); Meniere's Australia clinical management guidelines",
      whenToSeeSpecialist: "Urgent neurology or emergency referral if: vertigo with neurological symptoms (slurred speech, facial droop, arm/leg weakness, double vision, severe headache, gait ataxia) -- these suggest central cause (stroke, posterior fossa lesion). ENT specialist referral for: confirmed Meniere's disease, unilateral sensorineural hearing loss with vertigo, or BPPV not resolving with repositioning manoeuvres. Vestibular physiotherapy is highly effective for BPPV and vestibular neuritis rehabilitation.",
    },
    reviewedDate: "2026-03",
  },
}
