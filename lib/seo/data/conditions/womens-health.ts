      ...
      medications: [
        {
          ...
          keyPoints: [
            "First-line treatment for primary dysmenorrhoea per eTG -- prostaglandin inhibition reduces uterine cramping",
            "Naprogesic 275mg OTC is specifically indicated for period pain; start 1-2 days before expected onset for prophylactic effect",
            "More effective than paracetamol for period pain due to anti-prostaglandin mechanism",
            "Take with food; avoid in peptic ulcer disease, renal impairment, and cardiovascular disease",
          ],
        },
        {
          genericName: "Ibuprofen",
          brandNames: ["Nurofen", "Advil", "Ibuprofen Sandoz"],
          drugClass: "NSAID",
          typicalDose: "400mg every 6-8 hours with food; start 1-2 days before expected period; maximum 1200mg per day OTC",
          pbsListed: false,
          pbsNote: "Available OTC without prescription; shorter-acting than naproxen but equivalent efficacy",
          prescriptionRequired: false,
          availableOnline: false,
          keyPoints: [
            "Highly effective for primary dysmenorrhoea when started prophylactically",
            "Comparable efficacy to naproxen; shorter duration of action requires more frequent dosing",
            "Standard OTC formulations available; prescription-strength doses up to 2400mg/day",
          ],
        },
        {
          genericName: "Levonorgestrel-releasing intrauterine system",
          brandNames: ["Mirena", "Kyleena"],
          ...
          availableOnline: false,
          keyPoints: [
            "Highly effective for period pain and heavy menstrual bleeding -- reduces period pain in 80-90% of users",
            "Over time, most users experience significantly lighter or absent periods",
            "Requires in-person insertion by a trained clinician (GP or gynaecologist)",
            "A telehealth consult can discuss suitability and arrange a referral for insertion",
          ],
        },
      ],
      guidelineSource: "Therapeutic Guidelines -- Reproductive Health, 2023; Endometriosis Australia and Jean Hailes for Women's Health clinical recommendations; RANZCOG dysmenorrhoea management guideline",
      whenToSeeSpecialist: "Refer to a gynaecologist if: period pain is suspected to be secondary dysmenorrhoea (worsening pain, pain between periods, pain during sex, or pain on defecation during menstruation -- all suggestive of endometriosis), if heavy menstrual bleeding accompanies pain, if fertility concerns are present, or if an IUD insertion or diagnostic laparoscopy is being considered. Endometriosis Australia recommends specialist assessment for any woman with severe or progressive period pain.",
    },
      ...
      medications: [
        {
          ...
          keyPoints: [
            ...
            "Resistance rates in Australia approximately 15-20%; still effective for most patients",
        ...
        },
        {
          ...
          keyPoints: [
            ...
            "Avoid in renal impairment (eGFR below 30): poor urinary concentration reduces efficacy",
            "Can cause nausea; take with food",
            "Avoid at term (38+ weeks pregnancy) due to risk of neonatal haemolysis",
          ],
        },
      ],
