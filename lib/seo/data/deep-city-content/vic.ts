  ...
  melbourne: {
    ...
    pharmacyInfo: {
      ...
      paragraphs: [
        ...
        "Extended-hours pharmacies are common across Melbourne. Many Chemist Warehouse and Priceline locations in shopping centres and high streets stay open until 9pm. Several pharmacies in the CBD and inner suburbs operate late or 24 hours. This means prescriptions from InstantMed can be filled after doctor approval, even for evening requests.",
      ],
    },
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "For the estimated 5,000+ Ballarat residents who commute to Melbourne for work, healthcare access is doubly complicated. You're unwell, you can't get a same-day GP appointment in Ballarat, and you certainly can't make the 90-minute drive to a Melbourne clinic. Telehealth gives you an online pathway.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Review timing depends on doctor availability and whether follow-up information is needed. The eScript or PDF arrives via email or SMS, and you can forward it directly to your supervisor, employer, or labour hire provider. The request is handled online, with the outcome sent electronically after doctor approval. For Shepparton residents and workers across the Goulburn Valley, that is significantly faster than securing a same-day clinic appointment.",
        ],
      },
    ],
    pharmacyInfo: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Medical certificates for unplanned absences during harvest are a routine operational requirement. For workers without an established local GP, securing a same-day appointment during peak season is essentially impossible. Telehealth provides a consistent pathway: structured online intake, clinical assessment by an AHPRA-registered Australian doctor, and a PDF certificate forwarded directly to the supervisor or labour hire provider. For PALM scheme workers in particular, the standardisation and reliability are valuable.",
