    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "For residents of Busselton, Dunsborough, Margaret River, Augusta, and the smaller Capes-region communities, Bunbury is the usual stop for GP care. A round trip from Margaret River to Bunbury is 160 kilometres and two-and-a-half hours of driving, not including the time waiting at the clinic. Telehealth collapses all of that into an online process from home, without the fuel cost or the lost half-day.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "For residents of Margaret River, Augusta, and the smaller Capes communities, the practical difference is enormous. A round trip to a Bunbury GP for a routine certificate can absorb most of a working day, plus fuel and the inevitable waiting room time. Telehealth collapses that into an online process from home, with the same clinical standard and no compromise on the documentation. The two models work together - face-to-face for what genuinely needs it, telehealth for the routine middle.",
