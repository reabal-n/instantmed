...
export const audiencePageConfigs: Record<string, AudiencePageConfig> = {
  nurses: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Medical certificate requests can be submitted 24/7, including after a night shift. If approved, the certificate is delivered digitally.",
      },
      {
      ...
      },
      {
        ...
        a: "Many healthcare employers require a certificate for any absence. You can submit a request 24/7 and receive documentation digitally if approved.",
      },
      {
  ...
  teachers: {
    ...
    heroTagline: "No relief needed to see a doctor • Online request • Employer policies vary",
    icon: GraduationCap,
    metadata: {
      title: "Medical Certificates for Teachers | Online",
      description:
        "Teachers: get a medical certificate without taking time off. Doctor-reviewed, digital delivery if approved. School policies vary. Complete during lunch or after school.",
      keywords: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Medical certificate requests can be submitted 24/7. Submit at any time - even at 5am before school - and receive the certificate digitally if approved.",
      },
      {
  ...
  hospitality: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Medical certificate requests can be submitted 24/7. Submit anytime and receive documentation digitally if approved.",
      },
      {
        q: "How much does a medical certificate cost?",
  ...
  retail: {
    ...
    heroTagline: "Works around your roster • Online request • Employer policies vary",
    icon: ShoppingBag,
    metadata: {
  ...
  "office-workers": {
    ...
    heroTagline: "From your desk or home • Online request • Employer policies vary",
    icon: Briefcase,
    metadata: {
      title: "Medical Certificates for Office Workers",
      description:
        "Office workers: get a medical certificate without leaving work or home. Doctor-reviewed, digital delivery if approved. Built for corporate and government workplace documentation.",
      keywords: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Some corporate policies require documentation for any absence. You can submit a request online and receive documentation digitally if approved.",
      },
      {
  ...
  "remote-workers": {
    ...
    heroSubtext:
      "Work from home? Live regionally? Get your medical certificate without leaving the house. Doctor-reviewed, digital delivery if approved. Employer policies may vary.",
    heroTagline: "From anywhere • No commute • Employer policies vary",
    icon: Laptop,
    metadata: {
      title: "Medical Certificates for Remote Workers",
      description:
        "Remote workers: get a medical certificate from home. No clinic visit, no commute. Doctor-reviewed, digital delivery if approved. Works for WFH and regional workers.",
      keywords: [
  ...
  "gig-workers": {
    ...
    heroTagline: "No appointments • Online request • Clear absence record",
    icon: Car,
    metadata: {
      title: "Medical Certificates for Gig Workers",
      description:
        "Gig and contract workers: get a routine sick certificate when you're unwell. Doctor-reviewed, digital delivery if approved.",
      keywords: [
