    ...
    <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex gap-2 shrink-0">
          <button
            onClick={onDiscard}
            className="px-3 py-1.5 text-xs font-medium text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-950/40 rounded-md transition-colors"
          >
            Discard
          </button>
          <button
