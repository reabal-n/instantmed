              ...
              {variant === "marketing" && (
                <>
                  ...
                  <div className="ml-2 flex items-center gap-2">
                    ...
                    <span className="hidden lg:inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-50 dark:bg-amber-500/10 border border-amber-200/60 dark:border-amber-500/20 text-xs font-medium text-amber-700 dark:text-amber-300 whitespace-nowrap">
