            ...
            <div className="grid grid-cols-6 gap-1">
              {MONTHS.map((m) => (
                <button
                  ...
                  className={`py-1.5 rounded-lg text-xs font-medium transition-[background-color,color,border-color] duration-300 ${
                    expiryMonth === m.value
            ...
            <div className="flex gap-1 overflow-x-auto pb-1">
              {YEARS.map((y) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-[background-color,color,border-color] duration-300 whitespace-nowrap ${
                    expiryYear === y
                      ? "bg-primary text-primary-foreground shadow-md shadow-primary/25"
                      : "bg-white dark:bg-card text-foreground hover:bg-muted/50 border border-border/50"
                  }`}
