        ...
        {error ? (
          <Card className="border-warning-border bg-warning-light">
            <CardContent className="flex items-start gap-3 pt-6" role="alert">
              ...
              <div>
                <p className="text-sm font-medium text-warning">Stuck-intake status unavailable</p>
                <p className="text-sm text-warning/80">
                  We couldn&apos;t verify this queue. Refresh before treating an empty result as clear.
                </p>
              </div>
            </CardContent>
          </Card>
