...
const recentActions = [
  ...
  { name: "Emma L.", location: "Brisbane", action: "got a referral", time: "8 mins ago" },
  ...
  { name: "Sophie H.", location: "Canberra", action: "got a referral", time: "22 mins ago" },
    ...
    >
      <div className="glass-card rounded-2xl p-4 pr-6 shadow-xl max-w-xs cursor-pointer hover:scale-[1.02] transition-transform">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00E2B5] to-[#00C9A0] flex items-center justify-center flex-shrink-0">
