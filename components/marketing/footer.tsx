...
export function MarketingFooter() {
  ...
  return (
    <footer className="my-8 px-4 max-w-5xl mx-auto">
      ...
      <div className="relative bg-card rounded-3xl max-w-5xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6 border border-border shadow-sm">
        {/* Tape decorations */}
