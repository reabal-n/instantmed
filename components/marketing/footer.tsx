...
function FooterTrustBadges() {
  return (
    <div className="flex flex-col items-center gap-4 py-6 border-t border-dawn-200/30 dark:border-border/50">
      {/* Payment methods */}
