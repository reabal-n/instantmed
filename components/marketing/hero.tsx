...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-background min-h-[90vh] flex items-center">
      ...
      {/* Premium gradient orbs with indigo/violet glow */}
      <div className="absolute top-0 right-0 w-[700px] h-[700px] rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3" style={{ background: 'radial-gradient(circle, rgba(99,102,241,0.15) 0%, transparent 70%)' }} />
      ...
      <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] rounded-full blur-[60px] -translate-x-1/2 -translate-y-1/2" style={{ background: 'radial-gradient(circle, rgba(168,85,247,0.08) 0%, transparent 70%)' }} />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 pb-16 lg:pt-32 lg:pb-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="absolute -top-8 -right-8 w-32 h-32 rounded-3xl -z-10" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.2), rgba(139,92,246,0.1))', filter: 'blur(20px)' }} />
            <div className="absolute -bottom-8 -left-8 w-40 h-40 rounded-3xl -z-10" style={{ background: 'linear-gradient(135deg, rgba(139,92,246,0.15), rgba(168,85,247,0.1))', filter: 'blur(24px)' }} />
          </div>
        </div>
      </div>
    </section>
