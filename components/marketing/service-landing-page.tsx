...
// Color mapping: SOFT variants, not vibrant
const colorClasses = {
  emerald: {
  ...
  amber: {
    gradient: 'from-dawn-400 to-orange-500',
    light: 'bg-dawn-50',
    text: 'text-dawn-600',
    border: 'border-dawn-100',
    button: 'bg-dawn-500 hover:bg-dawn-600',
    ring: 'ring-dawn-400',
    iconBg: 'bg-dawn-50',
  },
  rose: {
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div {...fadeIn} className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
                ...
                >
                  <Link href={config.flowSlug === 'medical-certificate' ? '/request?service=med-cert' : '/request?service=prescription'}>
