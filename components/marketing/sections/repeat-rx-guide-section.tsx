...
const GUIDE_SECTIONS: Array<{
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The Pharmaceutical Benefits Scheme (PBS) subsidises thousands of medications in Australia. If your medication is PBS-listed, you'll pay the standard patient co-payment at the pharmacy - from 1 January 2026, up to $25.00 for general patients, or $7.70 for concession card holders (frozen until 2030). These rates apply regardless of whether your prescription came from a telehealth consultation or a traditional GP visit. Source: pbs.gov.au/info/healthpro/explanatory-notes/front/fee",
      "The PBS Safety Net provides additional protection for patients with high medication costs. From 1 January 2026, once you or your family reach the annual threshold - $1,748.20 for general patients or $277.20 for concession card holders - your co-payments reduce for the remainder of the calendar year. Your pharmacy tracks your Safety Net total, so make sure you're asking them to record each purchase. Source: servicesaustralia.gov.au/pbs-safety-net-thresholds",
