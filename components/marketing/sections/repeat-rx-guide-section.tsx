...
import { BadgeCheck, Smartphone, Stethoscope, DollarSign, Pill, UserCheck } from "lucide-react"
...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "The $29.95 consultation fee covers the doctor's clinical assessment and the issuing of your eScript. It does not include the cost of the medication itself — that's a separate transaction at your pharmacy, and PBS subsidies apply exactly as they would with any other prescription.",
