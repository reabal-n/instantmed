  ...
  return (
    ...
    >
      ...
      <div className="relative px-4 py-5">
        ...
        <div
          className="relative z-10 mx-auto my-3 flex h-7 w-7 items-center justify-center rounded-full border border-border bg-background text-sm font-semibold text-muted-foreground"
          aria-hidden="true"
        >
          OR
        </div>
