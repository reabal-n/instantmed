      ...
      <motion.div variants={staggerChildren} className="space-y-3">
        ...
        {formData.certType === "carer" && (
          <motion.div
            ...
            className="p-4 rounded-2xl bg-amber-50/80 dark:bg-amber-500/20 border border-amber-200/50 dark:border-amber-800/30 shadow-[0_4px_16px_rgb(245,158,11,0.15)] text-sm"
          >
