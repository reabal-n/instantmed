...
export function IntakeSkeleton({ className, variant = "form" }: IntakeSkeletonProps) {
    ...
    return (
      <div className={cn("space-y-6 animate-in fade-in duration-300", className)}>
        ...
        <div className="space-y-2">
          <div className="h-7 w-48 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
          <div className="h-4 w-64 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
        </div>
  ...
  if (variant === "review") {
    return (
      <div className={cn("space-y-6 animate-in fade-in duration-300", className)}>
        {/* Header skeleton */}
        <div className="space-y-2">
          <div className="h-7 w-40 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
          <div className="h-4 w-56 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
        </div>
        ...
        <div className="flex justify-between items-center pt-4 border-t">
          <div className="h-5 w-16 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
          <div className="h-8 w-24 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
        </div>
        
        {/* Button skeleton */}
        <div className="h-12 w-full bg-card/40 dark:bg-white/10 rounded-xl animate-pulse" />
      </div>
    )
  }
  ...
  return (
    <div className={cn("space-y-6 animate-in fade-in duration-300", className)}>
      {/* Header skeleton */}
      <div className="space-y-2">
        <div className="h-7 w-52 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
        <div className="h-4 w-72 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
      </div>
      ...
      {/* Button skeleton */}
      <div className="h-12 w-full bg-card/40 dark:bg-white/10 rounded-xl animate-pulse mt-8" />
    </div>
  )
}
      ...
      <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-lg border-b">
        <div className="max-w-lg mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 bg-card/40 dark:bg-white/10 rounded-lg animate-pulse" />
            <div className="h-5 w-32 bg-card/40 dark:bg-white/10 rounded animate-pulse" />
          </div>
