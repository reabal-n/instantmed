 ...
 * the answer-engine-cited keystone, then Google. Both link off-site through
 ...
 * never suggests what to write. Honest reviews, good or bad, are welcome.
 */
const DESTINATIONS = [
      ...
      <div className="flex flex-col gap-3">
        <div className="space-y-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            sentences is plenty. Please leave out personal or medical details:
            reviews are public.
          </p>
        </div>
