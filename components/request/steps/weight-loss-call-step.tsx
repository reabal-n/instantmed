    ...
    <div className="space-y-6">
      ...
      <Alert variant="default" className="border-primary/20 bg-primary/5">
        ...
        <AlertDescription className="text-xs">
          A doctor will call you for a brief consultation to discuss your weight loss goals and ensure the treatment is right for you. Review timing depends on doctor availability.
        </AlertDescription>
      </Alert>
      ...
      <div className="p-4 rounded-xl border bg-muted/30 space-y-2">
        ...
        <ul className="space-y-1.5 text-xs text-muted-foreground">
          <li className="flex items-start gap-2">
            ...
            <span>A doctor will call when available</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
          ...
          <li className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
            <span>If suitable, a prescription can be sent digitally</span>
          </li>
        </ul>
      </div>
