        ...
        >
          <div
            className={`rounded-xl border transition-all duration-300 ${
              openId === faq.id
                ? "bg-white/80 dark:bg-black/40 border-[#00E2B5]/30 shadow-[0_8px_30px_rgb(0,226,181,0.1)]"
                : "bg-white/50 dark:bg-black/20 border-white/20 dark:border-white/10 hover:border-[#00E2B5]/20"
            }`}
          >
            <button
            ...
            >
              <div className="flex items-center gap-3">
                {showCategories && faq.category && (
                  <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-[#00E2B5]/10 text-[#00E2B5]">
                    {faq.category}
                  </span>
                )}
              ...
              {openId === faq.id && (
                ...
                >
                  <div className="px-5 pb-5 pt-0">
                    <div className="pl-0 border-l-2 border-[#00E2B5]/30">
