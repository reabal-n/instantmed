...
function getStyles(size: number, scopeId: string) {
  return `
  ...
  .sky-toggle-${scopeId} .theme-switch__container {
  ...
  .sky-toggle-${scopeId} .theme-switch__container::before {
    content: ""; position: absolute; z-index: 1; inset: 0;
    box-shadow: 0em 0.05em 0.187em rgba(0,0,0,0.25) inset, 0em 0.05em 0.187em rgba(0,0,0,0.25) inset;
    border-radius: var(--container-radius);
  }
  .sky-toggle-${scopeId} .theme-switch__checkbox { display: none; }
  .sky-toggle-${scopeId} .theme-switch__circle-container {
  ...
  .sky-toggle-${scopeId} .theme-switch__sun-moon-container {
  ...
  .sky-toggle-${scopeId} .theme-switch__spot:nth-of-type(2) { width: 0.375em; height: 0.375em; top: 0.937em; left: 1.375em; }
  .sky-toggle-${scopeId} .theme-switch__spot:nth-last-of-type(3) { width: 0.25em; height: 0.25em; top: 0.312em; left: 0.812em; }
  .sky-toggle-${scopeId} .theme-switch__clouds {
  ...
  .sky-toggle-${scopeId} .theme-switch__checkbox:checked + .theme-switch__container { background-color: var(--container-night-bg); }
  .sky-toggle-${scopeId} .theme-switch__checkbox:checked + .theme-switch__container .theme-switch__circle-container { left: calc(100% - var(--circle-container-offset) - var(--circle-container-diameter)); }
  .sky-toggle-${scopeId} .theme-switch__checkbox:checked + .theme-switch__container .theme-switch__circle-container:hover { left: calc(100% - var(--circle-container-offset) - var(--circle-container-diameter) - 0.187em); }
  .sky-toggle-${scopeId} .theme-switch__circle-container:hover { left: calc(var(--circle-container-offset) + 0.187em); }
