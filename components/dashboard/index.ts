 ...
 * 
 * 21st.dev-inspired glass-forward dashboard components.
 * Designed for sleek dark mode with seamless light mode support.
 * 
 * Usage:
 * import { DashboardCard, GlassStatCard, GlowBadge } from "@/components/dashboard"
 */
