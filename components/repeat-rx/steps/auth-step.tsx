      ...
      <div className="space-y-4">
        <div className="p-5 rounded-2xl border border-border bg-card space-y-4">
          ...
          <Button
            ...
            onClick={onGuest}
            disabled={isLoading}
            className="w-full h-12 rounded-full bg-white dark:bg-card border border-border/50 hover:bg-muted/50 hover:shadow-[0_4px_12px_rgb(59,130,246,0.1)] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-card border border-border/50 shadow-sm shadow-primary/[0.04] space-y-2">
