...
import {
  composeConfigs as composeConfigs2,
  composeStories as originalComposeStories2,
  composeStory as originalComposeStory2,
  setProjectAnnotations as originalSetProjectAnnotations2,
  setDefaultProjectAnnotations as setDefaultProjectAnnotations2
} from "storybook/preview-api";

// ../../renderers/react/src/portable-stories.tsx
...
var { FRAMEWORK_OPTIONS } = scope, ErrorBoundary = class extends ReactComponent {
  constructor() {
    super(...arguments);
...
// ../../renderers/react/src/mount.ts
var mount = (context) => async (ui) => (ui != null && (context.originalStoryFn = () => ui), await context.renderToCanvas(), context.canvas);

// ../../renderers/react/src/applyDecorators.ts
import React4 from "react";
import { defaultDecorateStory } from "storybook/preview-api";
var applyDecorators = (storyFn, decorators2) => defaultDecorateStory((context) => React4.createElement(storyFn, context), decorators2);
...
var decorators = [
  (story, context) => {
    if (!context.parameters?.react?.rsc)
      return story();
    let [major, minor] = React5.version.split(".").map((part) => parseInt(part, 10));
...
// ../../renderers/react/src/extractProps.ts
import {
  TypeSystem,
...
// ../../renderers/react/src/docs/lib/captions.ts
...
// ../../renderers/react/src/docs/lib/inspection/inspectValue.ts
...
// ../../renderers/react/src/docs/lib/defaultValues/generateObject.ts
import {
...
// ../../renderers/react/src/docs/lib/defaultValues/prettyIdentifier.ts
...
// ../../renderers/react/src/docs/lib/defaultValues/createFromRawDefaultProp.ts
import {
...
var createStringTreeNode = function(value) {
...
}, supportFragment = !!Fragment2, getFunctionTypeName = function(functionType) {
  ...
  return supportFragment && element.type === Fragment2 ? createReactFragmentTreeNode(key, childrens) : createReactElementTreeNode(displayName, props, defaultProps, childrens);
};
function noRefCheck() {
}
...
// ../../renderers/react/src/docs/propTypes/createType.ts
import { createSummaryValue as createSummaryValue5, isTooLongForTypeSummary } from "storybook/internal/docs-tools";

// ../../renderers/react/src/docs/propTypes/generateFuncSignature.ts
...
// ../../renderers/react/src/docs/propTypes/rawDefaultPropResolvers.ts
...
// ../../renderers/react/src/docs/propTypes/sortProps.ts
...
// ../../renderers/react/src/docs/propTypes/handleProp.ts
...
// ../../renderers/react/src/docs/typeScript/handleProp.ts
...
// ../../renderers/react/src/extractArgTypes.ts
...
function setProjectAnnotations(projectAnnotations) {
  return setDefaultProjectAnnotations2(INTERNAL_DEFAULT_PROJECT_ANNOTATIONS2), originalSetProjectAnnotations2(
    projectAnnotations
  );
}
var INTERNAL_DEFAULT_PROJECT_ANNOTATIONS2 = composeConfigs2([
  INTERNAL_DEFAULT_PROJECT_ANNOTATIONS,
  preview_exports
]);
function composeStory(story, componentAnnotations, projectAnnotations, exportsName) {
  return originalComposeStory2(
    story,
    componentAnnotations,
    projectAnnotations,
    globalThis.globalProjectAnnotations ?? INTERNAL_DEFAULT_PROJECT_ANNOTATIONS2,
    exportsName
  );
}
function composeStories(csfExports, projectAnnotations) {
  return originalComposeStories2(csfExports, projectAnnotations, composeStory);
}
