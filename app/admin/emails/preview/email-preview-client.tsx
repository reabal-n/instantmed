/**
 * @deprecated THIS FILE IS DEAD CODE. It is not imported by any page.
 *
 * The admin email preview page (page.tsx) uses `EmailPreviewReactClient` from
 * `email-preview-react-client.tsx` instead, which renders real React email
 * templates via server actions and sends real test emails.
 *
 * This file contains a hardcoded HTML preview and a FAKE test send
 * (setTimeout-based). Do NOT use this component.
 *
