      ...
      <main className="flex-1">
        ...
        <section className="pt-32 pb-10 px-4">
          <div className="mx-auto max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl font-semibold text-foreground mb-2">Terms of Service</h1>
        ...
        <section className="pb-24 px-4">
          <div className="mx-auto max-w-3xl">
            <div className="bg-white dark:bg-card rounded-2xl border border-border/50 dark:border-white/10 shadow-sm p-8 sm:p-12 divide-y divide-border/40">
