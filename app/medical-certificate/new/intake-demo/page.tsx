...
export default function IntakeDemoPage() {
  ...
  const canContinue = (() => {
    switch (currentStep) {
      ...
      case 6: return true // Payment step
      default: return true
    }
  })()

  // Hide navigation on certain steps (intro, "who", and review steps)
  const hideNavigation = currentStep === 0 || currentStep === 1 || currentStep === 5
                ...
                >
                  ...
                  >
                    ...
                    <Switch
                      ...
                      onCheckedChange={setHasEmergencySymptoms}
          ...
          case 6:
            return (
              <StepContent
                ...
                description="Secure payment processed by Stripe."
              >
                <div className="space-y-6">
                  ...
                  <div className="p-6 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Payment form would be embedded here
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
