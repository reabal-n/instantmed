...
const howItWorksFaqs = [
  ...
  { question: "What if my request is declined?", answer: "You get a full refund. If your situation requires in-person care or falls outside what telehealth can safely manage, the doctor will recommend appropriate next steps." },
