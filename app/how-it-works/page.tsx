          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="relative">
                {/* Connection line */}
                <div className="absolute left-10 md:left-[39px] top-24 bottom-24 w-0.5 bg-linear-to-b from-indigo-500/50 via-violet-500/20 to-indigo-500/50 hidden md:block" />
                ...
                <div className="space-y-8 md:space-y-12">
                  {steps.map((step, index) => (
                    ...
                    >
                      {/* Icon */}
                      <div
                        className={`w-20 h-20 rounded-2xl bg-linear-to-br ${step.color} flex items-center justify-center shadow-lg shadow-primary/20 shrink-0 relative`}
                      >
