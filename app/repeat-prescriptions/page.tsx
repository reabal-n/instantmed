...
const repeatRxFaqs = [
  ...
  { question: "Is this a private service or bulk-billed?", answer: `This is a private service at ${PRICING_DISPLAY.REPEAT_SCRIPT} per consultation. Medicare rebates don't apply, but PBS subsidies still apply at the pharmacy. The ${PRICING_DISPLAY.REPEAT_SCRIPT} covers the doctor's assessment, not the medication itself.` },
