...
function getErrorInfo(error: Error & { digest?: string }) {
  ...
  return {
    ...
    description: "Something went wrong loading this patient record. Data is safe.",
    icon: AlertTriangle,
  }
}

export default function DoctorPatientError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    import("@sentry/nextjs").then((Sentry) => {
      Sentry.captureException(error, {
        tags: { boundary: "doctor-patient", errorType: errorInfo.type },
