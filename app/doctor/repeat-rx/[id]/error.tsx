...
function getErrorInfo(error: Error & { digest?: string }) {
  ...
  return {
    ...
    title: "Error loading repeat prescription",
    description: "Something went wrong loading this prescription request. Data is safe.",
    icon: AlertTriangle,
  }
}

export default function DoctorRepeatRxError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    import("@sentry/nextjs").then((Sentry) => {
      Sentry.captureException(error, {
        tags: { boundary: "doctor-repeat-rx", errorType: errorInfo.type },
