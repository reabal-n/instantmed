...
export default function MedicationError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Error loading page</h1>
        <p className="text-muted-foreground mb-6">
          Something went wrong loading this medication page. Please try again.
        </p>
