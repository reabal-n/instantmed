...
export const metadata: Metadata = {
  ...
  description:
    "Telehealth in Australia explained — how it works, what it costs, the Medicare and PBS rules, and which conditions are suitable for virtual care. InstantMed delivers AHPRA-governed telehealth nationwide from $19.95.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "A practical guide to telehealth in Australia: regulation, cost, Medicare, suitable conditions, and how to get started. From $19.95 with AHPRA-registered doctors.",
    url: CANONICAL,
    siteName: "InstantMed",
    locale: "en_AU",
    type: "website",
