...
export const metadata: Metadata = {
  ...
  description:
    "InstantMed operates under AHPRA-registered medical governance. Prescribing and concerning requests are reviewed by Australian doctors under documented clinical standards and escalation rules.",
  openGraph: {
