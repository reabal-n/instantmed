...
export const metadata: Metadata = {
  ...
  description: `Start, switch or continue the contraceptive pill after Australian doctor review. Secure form-first assessment, no booked appointment. From ${PRICING_DISPLAY.WOMENS_HEALTH}.`,
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Start, switch or continue the contraceptive pill after secure form-first review by an Australian doctor.",
  ...
  return (
    <>
      <SpeakableSchema
        ...
        description={`Start, switch or continue the contraceptive pill after AHPRA-registered Australian doctor review. From ${PRICING_DISPLAY.WOMENS_HEALTH}. The doctor reviews your safety screen and decides what is clinically appropriate.`}
      ...
      <ServiceSchema
        ...
        description="Start, switch or continue the contraceptive pill after AHPRA-registered Australian doctor review. Next steps are decided after clinical review."
        price={PRICING_SCHEMA.WOMENS_HEALTH}
        url="/contraceptive-pill-assessment-online"
      />
      <HealthArticleSchema
        title="Contraceptive Pill Assessment Online"
        description={`Start, switch or continue the contraceptive pill after AHPRA-registered Australian doctor review. Secure form-first review. From ${PRICING_DISPLAY.WOMENS_HEALTH}.`}
        url="/contraceptive-pill-assessment-online"
