...
export const metadata: Metadata = {
  title: "Get Started",
  description:
    "Medical certificates from $19, repeat prescriptions $29.95, doctor consultations from $49.95. Reviewed by Australian doctors. Most requests completed within 30 minutes.",
  openGraph: {
