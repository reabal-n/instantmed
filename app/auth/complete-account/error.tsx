...
export default function CompleteAccountError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    import("@sentry/nextjs").then((Sentry) => {
      Sentry.captureException(error, {
        tags: { boundary: "auth-complete-account" },
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Account Setup Error</h1>
