...
export default function PostSignInError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    import("@sentry/nextjs").then((Sentry) => {
      Sentry.captureException(error, {
        tags: { boundary: "auth-post-signin" },
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Sign-in Error</h1>
        <p className="text-muted-foreground mb-6">
          Something went wrong after signing in. Please try again.
        </p>
