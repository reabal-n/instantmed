...
const CITY_CONTENT: Record<string, string> = {
  ...
  hobart: "Hobart and Southern Tasmania have limited after-hours doctor options. InstantMed lets you submit focused medical-certificate and repeat-prescription requests online seven days a week without leaving home.",
  ...
  geelong: "Geelong is growing fast, and doctor availability hasn't kept up. InstantMed lets you submit requests without the drive to Melbourne or the wait at a walk-in clinic.",
  townsville: "North Queensland's limited specialist availability makes telehealth valuable. InstantMed lets Townsville patients submit focused medical-certificate and repeat-prescription requests online, rain or shine.",
  ...
  toowoomba: "Toowoomba and the Darling Downs can face doctor shortages, especially outside business hours. InstantMed lets you submit focused medical-certificate and repeat-prescription requests online.",
  ballarat: "Ballarat and regional Victoria have fewer doctor options than Melbourne. InstantMed lets you submit medical certificate and repeat prescription requests without the drive or the wait.",
  ...
  launceston: "Northern Tasmania's doctor availability can be limited. InstantMed lets you submit focused medical-certificate and repeat-prescription requests online seven days a week.",
  ...
  bunbury: "South-West WA has fewer doctor options than Perth. InstantMed lets Bunbury and surrounding area residents submit focused medical-certificate and repeat-prescription requests online without a trip to the city.",
  ...
  parramatta: "Parramatta and Western Sydney face some of the longest GP wait times in the country. InstantMed lets you submit focused medical-certificate and repeat-prescription requests online without the commute.",
  "bondi-beach": "Eastern suburbs residents know the drill: packed medical centres and long waits. InstantMed lets you submit a medical certificate or repeat prescription request without the queue.",
  fremantle: "Fremantle and the port city have distinct healthcare challenges. InstantMed lets you submit focused medical-certificate and repeat-prescription requests online without the trip into Perth.",
  "central-coast": "The Central Coast stretches from Gosford to The Entrance, and doctor availability varies. InstantMed lets residents submit focused medical-certificate and repeat-prescription requests online without driving to Sydney.",
  ...
  "port-macquarie": "The Mid North Coast has a significant retiree population and limited after-hours options. InstantMed lets residents submit focused medical-certificate and repeat-prescription requests online seven days a week.",
  ...
  dubbo: "Dubbo is the hub of the Orana region. Healthcare access can be challenging. InstantMed lets residents submit focused medical-certificate and repeat-prescription requests online from anywhere with internet access.",
  mildura: "Sunraysia's isolation makes telehealth valuable. InstantMed lets Mildura and Mallee residents submit focused medical-certificate and repeat-prescription requests online without the long drive to Melbourne.",
  ...
  gladstone: "Gladstone's industrial workforce often works shifts. InstantMed is designed to work around irregular hours, with certificate and repeat prescription requests available online.",
