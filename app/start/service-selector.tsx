...
import { MagneticCard, HolographicCard } from "@/components/ui/glowing-effect"
              ...
              <BlurFade key={service.id} delay={0.1 + i * 0.1}>
                <Link href={service.href} className="group block h-full">
                  <MagneticCard intensity={8} scale={1.02} borderRadius="1.5rem">
                    <HolographicCard borderRadius="1.5rem" intensity={0.5}>
                      <div className={`relative h-full rounded-3xl overflow-hidden bg-linear-to-br ${service.gradient} p-1 transition-all duration-300 hover:shadow-2xl`}>
