          ...
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-card rounded-2xl border p-6 md:p-8">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p>
                    Most Australian universities require students to submit a medical certificate within 3-5 business days of a missed assessment. InstantMed requests can be submitted 24/7, so students can seek documentation even on weekends, public holidays, or during after-hours exam periods when GP clinics are closed.
                  </p>
                  <p>
