              ...
              <div className="flex items-start gap-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    consentMyhr ? "bg-primary shadow-[0_8px_30px_rgb(59,130,246,0.3)]" : "bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-white/40 dark:border-white/10"
                  )}
                >
                  <span
                    className={cn(
