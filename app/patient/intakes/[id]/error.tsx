...
function getErrorInfo(error: Error & { digest?: string }) {
  ...
  return {
    ...
    description: "Something went wrong loading your request details. Your data is safe.",
    icon: AlertTriangle,
  }
}

export default function PatientIntakeError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    import("@sentry/nextjs").then((Sentry) => {
      Sentry.captureException(error, {
        tags: { boundary: "patient-intake", errorType: errorInfo.type },
