...
ROUTE_BUDGETS=(
  ...
  "/dashboard|37|401|The 2026-07-16 money-page consolidation changed Webpack chunk ownership without changing dashboard source: 14 unchanged modules moved from a shared chunk into the route entry, so Next's unique estimate rose from 29.9 to 36.8 kB. Actual initial dashboard JS fell from 390 to 389 kB. Re-baselined 400->401 on 2026-08-31 for the Next 15.5.24 security patch: same-environment clean builds showed no dashboard source change and only 275 raw bytes of dependency-generated manifest growth (1,331,795->1,332,070), which crossed Next's whole-kilobyte output boundary. Investigate any further real increase before changing it."
