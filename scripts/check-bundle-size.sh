...
ROUTE_BUDGETS=(
  ...
  "/dashboard|30|425|The staff cockpit is carrying too much client runtime. Current ceiling reflects AttributionSourcesCard + DeclineReasonsCard + CounterCard + RecoveryRow + geographic tile + calm-chrome pass + 2026-05-26 cockpit polish (route JS 24 to 30 kB, first-load 405 to 425 kB). 2026-05-29: bumped 420 to 425 to unblock CI after the cockpit-polish commits crossed 420 by 1 kB; the dynamic-import pass (e.g. queue panels behind a click) is now OVERDUE and should land before any further bump."
