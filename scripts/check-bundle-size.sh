...
ROUTE_BUDGETS=(
  ...
  "/admin/intakes|23|445|The request ledger should not inherit heavy doctor-review code. Ceiling reflects shared cockpit primitives + refund indicator + renewal badge work (2026-05-20 to 2026-05-21); re-baselined 22->23 on 2026-06-26 for Webpack split-chunk variance (measured 21.9-22.1 kB across builds, no ledger code delta); first-load re-baselined 455->445 on 2026-07-12: the acquisition-source row label is classified SERVER-side (app/admin/intakes/page.tsx) precisely to keep the 10-group classifier (and its zod-bearing heard-about-us import) out of this bundle — measured 440 kB after the move (classifying in the client mapper had measured 457-459), so 445 = measured + split-chunk variance margin and is TIGHTER than the old 455 baseline."
