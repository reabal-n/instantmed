...
ROUTE_BUDGETS=(
  ...
  "/admin/intakes|23|458|The request ledger should not inherit heavy doctor-review code. Ceiling reflects shared cockpit primitives + refund indicator + renewal badge work (2026-05-20 to 2026-05-21); re-baselined 22->23 on 2026-06-26 for Webpack split-chunk variance (measured 21.9-22.1 kB across builds, no ledger code delta); first-load re-baselined 455->458 on 2026-07-12 for the acquisition-source row label (buildCaseRowAttribution + the shared 10-group classifier, measured 457 kB — rows are mapped/filtered client-side so the classifier is legitimately client code)."
