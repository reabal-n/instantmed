...
declare -a CHECKS=(
  ...
  'border-l-[2-9]|colored left-stripe accent, disallowed by the project portal surface contract.'
  'border-l-1[0-9]|colored left-stripe accent, disallowed by the project portal surface contract.'
