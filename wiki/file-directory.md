...
| `app/api/internal/support-inbox-alert/route.ts` | Manual aggregate-only support count diagnostic; production flag off | Deliberate support alert diagnostics | Critical |
