-- Restore canonical intake transitions for payment recovery, cancellation, and decline.
-- This keeps the app's existing payment retry/rejection paths aligned with the DB trigger.
