-- Restore the final atomic approval RPC outside the squashed baseline.
-- The squashed baseline skips this large body because Supabase Preview parses that replay unreliably.
