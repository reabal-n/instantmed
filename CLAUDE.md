...
- **Staff cockpit shell**: Admin and admin-doctor staff screens use `OperatorShell`/`components/operator/*`. Do not reintroduce separate admin/doctor mode switching, scroll-heavy dashboard pages, or duplicate case summary layouts; put operational actions above the clinical review context.
