...
export function OrganizationSchema({ baseUrl = "https://instantmed.com.au" }: OrganizationSchemaProps) {
  const schema = {
    ...
    description: "Australia's fastest online telehealth service. Get medical certificates, prescriptions, and referrals from registered Australian doctors in hours, not days.",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description: "Get referrals to specialists and imaging services"
          }
        }
      ]
    }
...
export function LocalBusinessSchema({ city, state, baseUrl = "https://instantmed.com.au" }: LocalBusinessSchemaProps) {
  const schema = {
    ...
    serviceType: "Telehealth",
    description: `Online telehealth services for ${city} residents. Get medical certificates, prescriptions, and referrals from Australian doctors.`
  }
