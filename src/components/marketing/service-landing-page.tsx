...
export function ServiceLandingPage({ config }: ServiceLandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white pt-24 pb-16 lg:pt-32 lg:pb-24">
        {/* Background elements */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div {...fadeIn} className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
                ...
                >
                  <Link href={`/start?service=${config.flowSlug}`}>
                    Get started
      ...
      {/* Final CTA */}
      <section className={cn('py-20 lg:py-28 bg-gradient-to-r', colors.gradient)}>
